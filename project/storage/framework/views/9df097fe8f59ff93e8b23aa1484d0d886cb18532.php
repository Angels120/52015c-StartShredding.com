...
<link href="<?php echo e(URL::asset('new_assets/assets/plugins/pace/pace-theme-flash.css')); ?>" rel="stylesheet" type="text/css" />
<link href="<?php echo e(URL::asset('new_assets/assets/plugins/bootstrap/css/bootstrap.min.css')); ?>" rel="stylesheet"
      type="text/css" />
<link href="<?php echo e(URL::asset('new_assets/assets/plugins/font-awesome/css/font-awesome.css')); ?>" rel="stylesheet"
      type="text/css" />
<link href="<?php echo e(URL::asset('new_assets/assets/plugins/jquery-scrollbar/jquery.scrollbar.css')); ?>" rel="stylesheet"
      type="text/css" media="screen" />
<link href="<?php echo e(URL::asset('new_assets/assets/plugins/select2/css/select2.min.css')); ?>" rel="stylesheet" type="text/css"
      media="screen" />
<link href="<?php echo e(URL::asset('new_assets/assets/plugins/switchery/css/switchery.min.css')); ?>" rel="stylesheet"
      type="text/css" media="screen" />
<link href="<?php echo e(URL::asset('new_assets/assets/plugins/nvd3/nv.d3.min.css')); ?>" rel="stylesheet" type="text/css"
      media="screen" />
<link href="<?php echo e(URL::asset('new_assets/assets/plugins/mapplic/css/mapplic.css')); ?>" rel="stylesheet" type="text/css" />
<link href="<?php echo e(URL::asset('new_assets/assets/plugins/rickshaw/rickshaw.min.css')); ?>" rel="stylesheet" type="text/css" />
<link href="<?php echo e(URL::asset('new_assets/assets/plugins/bootstrap-datepicker/css/datepicker3.css')); ?>" rel="stylesheet"
      type="text/css" media="screen">
<link href="<?php echo e(URL::asset('new_assets/assets/plugins/jquery-datatable/media/css/dataTables.bootstrap.min.css')); ?>"
      rel="stylesheet" type="text/css" />
<link
        href="<?php echo e(URL::asset('new_assets/assets/plugins/jquery-datatable/extensions/FixedColumns/css/dataTables.fixedColumns.min.css')); ?>"
        rel="stylesheet" type="text/css" />
<link href="<?php echo e(URL::asset('new_assets/assets/plugins/datatables-responsive/css/datatables.responsive.css')); ?>"
      rel="stylesheet" type="text/css" media="screen" />
<link href="<?php echo e(URL::asset('new_assets/assets/plugins/jquery-metrojs/MetroJs.css')); ?>" rel="stylesheet" type="text/css"
      media="screen" />
<link href="<?php echo e(URL::asset('new_assets/pages/css/pages-icons.css')); ?>" rel="stylesheet" type="text/css">
<link href="<?php echo e(URL::asset('new_assets/pages/css/pages.css')); ?>" class="main-stylesheet" rel="stylesheet"
      type="text/css" />

<link href="<?php echo e(URL::asset('new_assets/assets/plugins/pace/pace-theme-flash.css')); ?>" rel="stylesheet" type="text/css" />
<link href="<?php echo e(URL::asset('new_assets/assets/plugins/select2/css/select2.min.css')); ?>" rel="stylesheet" type="text/css"
      media="screen" />
<link href="<?php echo e(URL::asset('/home_assets/images/form-wizard/pages.css')); ?>" rel="stylesheet" type="text/css" />
<link href="<?php echo e(URL::asset('/home_assets/images/form-wizard/style.css')); ?>" rel="stylesheet" type="text/css" />
<style>
    .top-right1 {
...
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/popper/umd/popper.min.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/bootstrap/js/bootstrap.min.js')); ?>" type="text/javascript">
</script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/jquery/jquery-easy.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/jquery-unveil/jquery.unveil.min.js')); ?>" type="text/javascript">
</script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/jquery-ios-list/jquery.ioslist.min.js')); ?>" type="text/javascript">
</script>
...
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/select2/js/select2.full.min.js')); ?>" type="text/javascript" src="">
</script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/classie/classie.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/switchery/js/switchery.min.js')); ?>" type="text/javascript">
</script>
...
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/nvd3/src/models/lineWithFocusChart.js')); ?>" type="text/javascript">
</script>
...
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/jquery-metrojs/MetroJs.min.js')); ?>" type="text/javascript">
</script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/jquery-sparkline/jquery.sparkline.min.js')); ?>"
        type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/skycons/skycons.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js')); ?>"
        type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/jquery-datatable/media/js/jquery.dataTables.min.js')); ?>"
        type="text/javascript"></script>
<script
        src="<?php echo e(URL::asset('new_assets/assets/plugins/jquery-datatable/extensions/TableTools/js/dataTables.tableTools.min.js')); ?>"
        type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/jquery-datatable/media/js/dataTables.bootstrap.js')); ?>"
        type="text/javascript"></script>
<script
        src="<?php echo e(URL::asset('new_assets/assets/plugins/jquery-datatable/extensions/Bootstrap/jquery-datatable-bootstrap.js')); ?>"
        type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/datatables-responsive/js/datatables.responsive.js')); ?>"
        type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/bootstrap-form-wizard/js/jquery.bootstrap.wizard.min.js')); ?>"
        type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/js/form_wizard.js')); ?>"
        type="text/javascript"></script>      
...
<script>
    $(document).ready(function(){
        ...
        $('#search').keyup(function(e){
            ...
            $.ajax({
                type:'POST',
                url:'<?php echo e(route("user.search-data")); ?>',
                //processData:false,
                //cache:false,
                dataType: "JSON",
                data:{
