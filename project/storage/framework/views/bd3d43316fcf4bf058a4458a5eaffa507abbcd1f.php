                            ...
                            <div class="client-info sm-m-b-3">
                                ...
                                <div class="row clearfix mb-1 sm-p-0 mt-4">
                                 ...
                                 <div class="row clearfix mb-2">
                                  <div class="col-md-6">
                                    <div class="form-group form-group-default required">
                                      <label>Phone</label>
                                      <input id="phone" type="tel" pattern="\d{3}\-\d{3}\-\d{4}" class="form-control telephone" data-mask="(999)-999-9999" placeholder="(999)-999-9999" required />
                                    </div>
                                  </div>
                                  <div class="col-md-6">
                                    <div class="form-group form-group-default">
                                      <label>Email</label>
                                      <input type="email" class="form-control" name="email" placeholder="joan@lifeforcephysio.com">
                                    </div>
                                  </div>
                                </div>
                               ...
                               <div class="row clearfix mb-1">
                                  <div class="col-md-6">
                                    <div class="form-group form-group-default required">
                                      ...
                                      <input type="text" class="form-control" name="firstName" placeholder="577" required>
                                    </div>
                                  </div>
                                  <div class="col-md-6">
                                    <div class="form-group form-group-default">
                                      <label>Addresss Line 2</label>
                                      <input type="text" class="form-control" name="lastName" placeholder="Burnhamthorpe Road">
                                    </div>
                                  </div>
                                </div>
                                <div class="row clearfix mb-1">
                                  <div class="col-md-4">
                                    <div class="form-group form-group-default required">
                                      <label>City</label>
                                      <input type="text" class="form-control" name="city" placeholder="Toronto" required>
                                    </div>
                                  </div>
                                  <div class="col-md-4">
                                    <div class="form-group form-group-default">
                                      <label>State/Province/Region</label>
                                      <input type="text" class="form-control" name="state" placeholder="Ontario">
                                    </div>
                                  </div>
                                  <div class="col-md-4">
                                    <div class="form-group form-group-default required">
                                      <label>Postal Code</label>
                                      <input type="text" class="form-control" name="postal" placeholder="M9C 2Y3" required>
                                    </div>
                                  </div>
                                </div>
                              <div class="row clearfix mb-2">
                                <div class="col-md-6">
                                  <div class="form-group form-group-default required">
                                    <label>Phone</label>
                                    <input type="text" class="form-control" name="phoneNumber" id="phoneNumber2" value="" placeholder="(999)-999-9999">
                                  </div>
                                </div>
                                <div class="col-md-6">
                                  <div class="form-group form-group-default">
                              ...
                              <div class="row clearfix mb-5">
                                <div class="col-md-6">
                                  <div class="form-group form-group-default required">
                                    <label>Phone</label>
                                    <input type="text" class="form-control" name="phoneNumber" id="phoneNumber3" value="" placeholder="(999)-999-9999">
                                  </div>
                                </div>
                                <div class="col-md-6">
                                  <div class="form-group form-group-default">
                                      ...
                                      <table class="table borderless no-margin">
                                        ...
                                        <tbody>
                                          <tr>
                                            ...
                                            <td class="text-center">Off Site -- Per File Box</td>
                                            <td class="text-center">$6.00</td>
                                            <td class="text-left">$360.00</td>
                                          </tr>
                                          <tr>
                                            <td class="text-center">50</td>
                                            <td class="text-center">Off Site -- Per File Box</td>
                                          ...
                                          <tr>
                                            ...
                                            <td class="text-left bold">$1080.00</td>
                                          </tr>
                                          <tr>
                                            <td class="text-center" colspan="2"></td>
                                            <td class="text-right">HST(13%)</td>
                                            <td class="text-left">$13.25</td>
                                          </tr>
                                          <tr>
