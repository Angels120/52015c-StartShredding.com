                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div id="exTab2" class="col-12">
                            <ul class="nav nav-tabs">
                                ...
                                <li class="active"><a href="<?php echo e(url('/vendor/customer/'.$client->id.'/templates')); ?>">Templates</a>
                                </li>
                                <li>
                                    <a href="<?php echo e(url('/vendor/customer/'.$client->id.'/orders')); ?>">Orders</a>
                                </li>
                            </ul>
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active mt-3" id="2">
                                    ...
                                    <div style="float: right;padding-bottom:20px;">
                                        <a href="<?php echo e(url('vendor/template/')); ?>/<?php echo e($client->id); ?>/create" class="btn btn-info float-right my-2">
    ...
    <script>
        ...
        $(function () {
            ...
            var table = $('#templates-table').DataTable({
                ...
                ajax: {
                    url: '<?php echo e(url('vendor/get-template-ajax')); ?>/<?php echo e($client->id); ?>?template_name=' + template_name + '&repeat=' + repeat + '&fromTime=' + fromTime+ '&toTime=' + toTime + '&type==' + type + '&orderForm=Search',
                },
                columns: [
                    {data: 'id', name: 'id'},
                    {
