            ...
            <div class="row">
                ...
                <div class="col-sm-5">
                    <div class="newAccount-area">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(route('home.register.submit')); ?>" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 form-group">
                                    ...
                                    <input name="address" id="pac-input" class="form-control" type="text"
                                           placeholder="Enter a location" value="<?php echo e(Session::get('address')); ?>" required
                                           autocomplete="off" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12 text-right">
                                        <a href="<?php echo e(route('home.user')); ?>">Already Have Account?</a>
                                    </div>
                                </div>
                            </div>
