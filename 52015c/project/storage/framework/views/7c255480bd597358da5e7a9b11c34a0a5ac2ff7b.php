                    ...
                    <div class="table-responsive">
                        <table data-export="1,2,3,4,5,6" cellpadding="0" cellspacing="0" id="table_1"
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="checkbox" name="chk_isActive[]" value="<?php echo e($order->id); ?>" <?php echo ($order->is_active)?'checked="checked"':''; ?>>
                                </td>
                            </tr>
                            <?php
                            }
        ...
        $(document).ready(function () {
            ...
            $('#makeActive').click(function(){
                ...
                if (confirmActive == true) {
                    ...
                    $.ajax({
                        url: '<?php echo e(url('/vendor/get-order-template-activate')); ?>',
                        type: 'POST',
                        data: {isActive_arr: isActive_arr,_token:'<?php echo e(csrf_token()); ?>'},
