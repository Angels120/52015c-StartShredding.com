...
<head>
    ...
    <link href="<?php echo e(URL::asset('assets2/css/style.css')); ?>" rel="stylesheet">

    <link rel="stylesheet" type="text/css"
        href="<?php echo e(URL::asset('assets2/font/font-awesome/css/font-awesome.min.css')); ?>" />
...
<body id="bd"
    class="cms-index-index4 header-style4 prd-detail sns-products-detail1 cms-simen-home-page-v2 default cmspage">
    <div id="sns_wrapper">
        <!-- Menu -->
                            ...
                            <div id="footer_bottom">
                                <div id="sns_footer_bottom" class="footer" style='background-color:black;z-index:999;'>
                                    <div class="icon-container">
                                        ...
                                        <a class="shcart" href="<?php echo e(url('/cart')); ?>"><i
                                        ...
                                        <div class="accountloy">
                                            <div class="inner">
                                                <a href="<?php echo e(route("user.product-favourite")); ?>"><i
                                                        class="fas fa-heart"></i><br><span
                                                        class="break"></span>Faves</a>
                                            </div>
                                            <div class="inner">
                                                <a href="<?php echo e(route('user.myorders')); ?>"><i
                                                        class="fas fa-file-invoice"></i><br><span
                                                        class="break"></span>Orders</a>

                                            </div>
                                            <div class="inner hid">
                                                <a href="<?php echo e(url('/locations')); ?>"><i
                                                        class="fas fa-map-marked-alt"></i><br><span
                                                        class="break"></span>Drop Off</a>
                                            </div>
                                        </div>
                                        <div class="transhop">
                                            <!-- <div class="inner hid">
                                                <a href="<?php echo e(url('/request-pickup')); ?>"><i
                                                        class="fas fa-phone-square"></i><br><span
                                                        class="break"></span>Request Pickup</a>
                                            </div> -->
                                            <div class="inner">
                                                <a href="<?php echo e(route("user-dashboard.index")); ?>"><i
                                                        class="fas fa-user-cog"></i><br><span
                                                        class="break"></span>Account</a>
                                            </div>
                                            <!-- <div class="inner">
                                                <a href="<?php echo e(url('/rewards')); ?>"><i class="fas fa-medal"></i><br><span
    ...
    var language = <?php echo json_encode($language); ?>;
        ...
        <script src="<?php echo e(URL::asset('assets2/js/less.min.js')); ?>"></script>
        <script src="<?php echo e(URL::asset('assets2/js/sns-extend.js')); ?>"></script>
        <script src="<?php echo e(URL::asset('assets2/js/custom.js')); ?>"></script>
        <script src="<?php echo e(URL::asset('assets2/js/bs-select.min.js')); ?>"></script>
