            ...
            <div class="row">
                ...
                <div class="col-sm-5">
                    <div class="newAccount-area">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(route('vendor.reg.submit')); ?>" method="post">
                            <?php echo e(csrf_field()); ?>

                            <div class="row">
                                <div class="col-sm-6 form-group">
                                    <label for="name">Vendor Name <span>*</span></label>
                                    <input class="form-control" value="<?php echo e(old('name')); ?>" type="text" name="name" id="name" required autocomplete="off">
                                </div>
                                <div class="col-sm-6 form-group">
                                    <label for="shop_name">Shop Name <span>*</span></label>
                                    <input class="form-control" value="<?php echo e(old('shop_name')); ?>" type="text" name="shop_name" id="shop_name" required autocomplete="off">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6 form-group">
                                    <label for="reg_email">Email Address<span>*</span></label>
                                    <input class="form-control" value="<?php echo e(old('email')); ?>" type="email" name="email" id="reg_email" required autocomplete="off">
                                </div>
                                <div class="col-sm-6 form-group">
                                    <label for="reg_Pnumber">Phone Number <span>*</span></label>
                                    <input id="yourphone" class="form-control" value="<?php echo e(old('phone')); ?>" type="text" name="phone" required autocomplete="off">
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-12 form-group">
                                    ...
                                    <input id="pac-input" class="form-control" type="text" placeholder="Enter a location" value="<?php echo e(Session::get('address')); ?>" required autocomplete="off">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6 form-group">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12 text-right">
                                        <a href="<?php echo e(url('/vendor')); ?>">Already Have Account?</a>
                                    </div>
                                </div>
                            </div>
