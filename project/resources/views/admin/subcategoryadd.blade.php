                ...
                <div class="panel-body">
                    ...
                    <form method="POST" action="{!! action('SubCategoryController@store') !!}"
                        ...
                        <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Main Category<span
                                    class="required">*</span>
                        ...
                        <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="slug">Category URL Slug<span
                                    class="required">*</span>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="checkbox">
                                    <label><input type="checkbox" name="featured" id="atofea" value="1"><strong>Add to
                        ...
                        <div class="item form-group" id="fimg" style="display: none;">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Add Featured Image<span
                                    class="required">*</span>
                                <p class="small-label">Must Be a Square Sized Image(250x250)</p>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
