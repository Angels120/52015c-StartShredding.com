										...
										if($earnings!=null){
											foreach ($earnings as $earning) {
												...
												<tr>
													...
													<td><a href="<?php echo url('vendor/details/'.$earning->orderid); ?>"><?=$earning->orderid?></a></td>
													<td><?=Config::get($statusKey)?></td>
													<td><a href="<?php echo url('vendor/profile/'.$getCustomerDetails->id); ?>"><?=$getCustomerDetails->name?></a></td>
													<td>$<?=$earning->cost?></td>
													<td>$(0)</td> 
													<td>$<?=$earning->cost?></td>
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<div class="col-lg-8 col-lg-offset-2">
									<form role="form" method="POST" action="<?php echo e(route('account.withdraw.submit')); ?>" class="form-horizontal form-label-left withdraw-form">
		                                ...
		                                <div class="form-group">
		                                    ...
		                                    <div class="col-md-6 col-sm-6 col-xs-12">
		                                        <input name="amount" placeholder="Withdraw Amount" value="<?php echo e(old('amount')); ?>" class="form-control"  type="text" required>
		                                    </div>
		                                </div>
		                                ...
		                                <div id="paypal" style="display: none;">
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-md-6 col-sm-6 col-xs-12">
		                                            <input name="acc_email" value="<?php echo e(old('email')); ?>" placeholder="Enter Account Email" class="form-control" type="email">
		                                        </div>
		                                    </div>
		                                ...
		                                <div id="bank" style="display: none;">
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-md-6 col-sm-6 col-xs-12">
		                                            <input name="iban" value="<?php echo e(old('iban')); ?>" placeholder="Enter IBAN/Account No" class="form-control" type="text">
		                                        </div>
		                                    </div>
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-md-6 col-sm-6 col-xs-12">
		                                            <input name="acc_name" value="<?php echo e(old('accname')); ?>" placeholder="Enter Account Name" class="form-control" type="text">
		                                        </div>
		                                    </div>
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-md-6 col-sm-6 col-xs-12">
		                                            <input name="address" value="<?php echo e(old('address')); ?>" placeholder="Enter Address" class="form-control" type="text">
		                                        </div>
		                                    </div>
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-md-6 col-sm-6 col-xs-12">
		                                            <input name="swift" value="<?php echo e(old('swift')); ?>" placeholder="Enter Swift Code" class="form-control" type="text">
		                                        </div>
		                                    </div>
		                                ...
		                                <div class="form-group">
		                                    ...
		                                    <div class="col-md-6 col-sm-6 col-xs-12">
		                                        <textarea class="form-control" name="reference" rows="6" placeholder="Additional Referance(Optional)"><?php echo e(old('reference')); ?></textarea>
		                                    </div>
		                                </div>
		
		                                <div id="resp" class="col-md-6 col-md-offset-3">
		
		                                    <?php if($settings[0]->withdraw_fee > 0): ?>
		                                        <span class="help-block">
		                                <strong>Withdraw Fee <?php echo e($settings[0]->currency_sign); ?><?php echo e($settings[0]->withdraw_fee); ?> and <?php echo e($settings[0]->withdraw_charge); ?>% will deduct from your account.</strong>
		                            </span>
		                                    <?php endif; ?>
		                                </div>
		                                <div class="form-group">
