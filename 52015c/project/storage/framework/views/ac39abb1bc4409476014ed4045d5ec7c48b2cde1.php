            ...
            <div class="row">
                ...
                <div class="col-sm-5">
                    <div class="newAccount-area">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(route('admin.reg.submit')); ?>" method="post">
                            <?php echo e(csrf_field()); ?>

                            <div class="row">
                                <div class="col-sm-6 form-group">
                                    <label for="reg_name">First Name <span>*</span></label>
                                    <input class="form-control" value="<?php echo e(old('fname')); ?>" type="text" name="fname" id="fname" required autocomplete="off">
                                ...
                                <div class="col-sm-6 form-group">
                                    ...
                                    <input class="form-control" value="<?php echo e(old('lname')); ?>" type="text" name="lname" id="lname" required="" autocomplete="off">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6 form-group">
                                    <label for="uname">Username<span>*</span></label>
                                    <input class="form-control" value="<?php echo e(old('uname')); ?>" type="text" name="uname" id="uname" required autocomplete="off">
                                </div>
                                <div class="col-sm-6 form-group">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12 text-right">
                                        <a href="<?php echo e(url('/admin')); ?>">Already Have Account?</a>
                                    </div>
                                </div>
                            </div>
                        </form>
