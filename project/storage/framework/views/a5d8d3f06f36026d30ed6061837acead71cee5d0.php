                ...
                <div
                        ...
                        <table class="table table-condensed  table-hover " id="tableStore1">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td class="fs-12"><a
                                            href="<?php echo e(url('user/order-details/')); ?>/<?php echo e($order->id); ?>"><u><?php echo e($order->order_number); ?></u></a>
                                    </td>
                    ...
                    <div class="padding-25 mt-auto">
                        <p class="small pull-right">
                            <a href="<?php echo e(url('user-orders')); ?>"><span>View Order History</span> <i
                ...
                <div class="widget-11-2 card no-border card-condensed no-margin widget-loader-circle ">
                        ...
                        <table class="table table-hover" id="tableStore">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td class="fs-12"><?php echo e($credits_detail->reference_id); ?></td>
                                    
                                    <td style="text-transform: uppercase;" class="fs-12"><?php echo e($credits_detail->type); ?></td>
                                    <td class="fs-12">
                                        <?php if($credits_detail->type == 'deposit' || $credits_detail->type == 'bonus'): ?>
                                        <span
                                            style="color:#00ae00">+<?php echo e($settings[0]->currency_sign); ?><?php echo e(number_format($credits_detail->amount, 2)); ?></span>
                                        <?php else: ?>
                                        <span
                                            style="color:#ff0000">-<?php echo e($settings[0]->currency_sign); ?><?php echo e(number_format($credits_detail->amount, 2)); ?></span>
                                        <?php endif; ?>
                    ...
                    <div class="padding-25 mt-auto">
                        <p class="small pull-right">
                            ...
                            <a href="<?php echo e(url('buy-credits')); ?>" class="btn btn-primary addcreadit-btn">Add Credits
                            </a>
                        </p>
