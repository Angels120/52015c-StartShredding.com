                                        ...
                                        <div class="product-carousel-text">
                                            ...
                                            <div class="product-price">
												<!--       @if($product->previous_price != "")
                                                    <span class="original-price"><img src="/assets2/images/rsign.png" style="margin-left: auto;margin-right: auto;display: inline;width:13px;height:16px;"> {{\App\Product::Cost($product->id)}}</span>
                                                @else
                                                @endif
                                                <del class="offer-price"><img src="/assets2/images/rsign.png" style="margin-left: auto;margin-right: auto;display: inline;width:13px;height:16px;"> {{$product->previous_price}}</del> -->
                                                @if($product->previous_price != "")
												                <del class="offer-price"><img src="/assets2/images/rsign.png" style="margin-left: auto;margin-right: auto;display: inline;width:10px;height:10px;"> {{$product->previous_price}}</del>
												            @endif
												                 <span class="original-price"><img src="/assets2/images/rsign.png" style="margin-left: auto;margin-right: auto;display: inline;width:16px;height:16px;"> {{\App\Product::Cost($product->id)}}</b></span>
                                            </div>
                                ...
                                @foreach($tops as $product)
                                    <div class="single-product-carousel-item text-center">
                                        ...
                                        <div class="product-carousel-text">
                                            ...
                                            <div class="product-price">
                                                <!-- @if($product->previous_price != "")
                                                    <span class="original-price"><img src="/assets2/images/rsign.png" style="margin-left: auto;margin-right: auto;width:12px;height:12px;">{{\App\Product::Cost($product->id)}}</span>
                                                @else
                                                @endif
                                                <del class="offer-price"><img src="/assets2/images/rsign.png" style="margin-left: auto;margin-right: auto;width:12px;height:12px;">{{$product->previous_price}}</del> -->
                                                @if($product->previous_price != "")
												                <del class="offer-price"><img src="/assets2/images/rsign.png" style="margin-left: auto;margin-right: auto;display: inline;width:10px;height:10px;"> {{$product->previous_price}}</del>
												            @endif
												                 <span class="original-price"><img src="/assets2/images/rsign.png" style="margin-left: auto;margin-right: auto;display: inline;width:16px;height:16px;"> {{\App\Product::Cost($product->id)}}</b></span>
