                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <form action="<?php echo e(route('user.login.submit')); ?>" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" value="<?php echo e(old('email')); ?>" type="email"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <form action="<?php echo e(route('user.reg.submit')); ?>" method="post">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" value="<?php echo e(old('first_name')); ?>"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" value="<?php echo e(old('last_name')); ?>"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="email">Email Address <span>*</span></label>
                                                        <input class="form-control" value="<?php echo e(old('email')); ?>"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="yourphone" class="form-control"
                                                            value="<?php echo e(old('phone')); ?>" type="text" name="phone"
                                                            id="phone" required="">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        class="fa fa-fw fa-eye field-icon toggle-password"></span>
                                            ...
                                            <div class="row">
                                                <div class="col col-lg-12">
                                                    <input id="pac-input" class="form-control" type="text"
                                                        ...
                                                        value="<?php echo e(Session::get('address')); ?>" autocomplete="off"
                                                        required><br>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col col-lg-12">
                                                    ...
                                                    <input type="hidden" value="<?php echo e(old('address')); ?>" name="address"
                                                        id="location">
                                                ...
                                                <table id="address" hidden>
                                                    <tr>
                                                        ...
                                                        <td class="wideField" colspan="2"><input class="field"
                                                                value="<?php echo e(old('route')); ?>" name="route" id="route"
                                                                disabled="true" /></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="label">City</td>
                                                        <td class="wideField" colspan="3"><input class="field"
                                                                value="<?php echo e(old('locality')); ?>" name="locality"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="wideField" colspan="3"><input class="field"
                                                                value="<?php echo e(old('country')); ?>" name="country" id="country"
                                                                disabled="true" /></td>
                                                    </tr>
                                                </table>
                                            </div>
                                        ...
                                        <input type="hidden" name="latitude" id="latitude"
                                            value="<?php echo e(Session::get('lat')); ?>" />
                                        <input type="hidden" name="logtitude" id="longitude"
                                            value="<?php echo e(Session::get('lng')); ?>" />
                                    ...
                                    <table id="productTable" class="table table-striped tabele-bordered"
                                        ...
                                        <tbody style="font-size: 12px; font-weight: 500;">
                                            ...
                                            <tr>
                                                <td>
                                                    <a
                                                        href="<?php echo e(route('product.details', ['id' => $res->id, 'title' => str_slug(str_replace(' ', '-', $res->title))])); ?>"><?php echo e($res->title); ?></a>
                                                </td>
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <form class="form-inline"
                                                                action="<?php echo e(route('coupon.remove')); ?>" method="POST">
                                                                <?php echo e(csrf_field()); ?>
