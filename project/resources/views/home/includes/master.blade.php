...
<head>
  ...
  <link class="main-stylesheet" href="{{ URL::asset('home_assets/new/style.css')}}" rel="stylesheet" type="text/css" />
  <link class="main-stylesheet" href="{{ URL::asset('home_assets/new/wizard.css')}}" rel="stylesheet" type="text/css" />
  ...
  <script src="{{ URL::asset('home_assets/new/jquery.steps.js')}}"></script>
  <script src="{{ URL::asset('home_assets/new/main.js')}}"></script>
