                                    ...
                                    <div class="container">
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-md-4 col-sm-12 col-xs-12">
                                                <h3 style="font-weight: 700;"><?php echo e($products->title); ?></h2>
                                                    <img style="width:270px;height:200px"
                                                        src="<?php echo e(URL::asset('assets/images/products/' . $products->feature_image)); ?>">
                                                    <form class="basic-form" style="margin-top: 20px;"
                                                        action="<?php echo e(route('home.order.update.details', $products->id)); ?>"
                                                        method="post">
                                                        ...
                                                        <div class="row col-md-12">
                                                            <div class="col-md-4 col-sm-12 col-xs-12">
                                                                <input class="form-control quantity" type="text"
                                                                    value="<?php echo e(Session::get('quantity')); ?>" name="quantity"
                                                                    maxlength="4">
                                                            </div>
                                                            <div class="col-md-4 col-sm-12 col-xs-12">
                                                                <select class="form-control" name="type"
                                                                    ...
                                                                    <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option value="<?php echo e($type->id); ?>"
                                                                            <?php if($type->id == Session::get('order_type')): ?> selected="selected" <?php endif; ?>>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align:center;">
                                                                    <h2><b><?php echo e("$" . number_format($priceList['standard'] * Session::get('quantity'), 2)); ?></b>
                                                                    </h2>
                                                                </td>
                                                                <td style="text-align:center;">
                                                                    <h2><b><?php echo e("$" . number_format($priceList['flex'] * Session::get('quantity'), 2)); ?></b>
                                                                    </h2>
                                                                </td>
                                                                <td style="text-align:center;">
                                                                    <h2><b><?php echo e("$" . number_format($priceList['expedited'] * Session::get('quantity'), 2)); ?></b>
                                                                    </h2>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align:center;">
                                                                    <?php if(!Auth::guard('profile')->user()): ?>
                                                                        <a onclick="placeOrder('<?php echo e($products['id']); ?>','<?php echo e(number_format($priceList['standard'], 2)); ?>','Standard');"
                                                                            href="#"
                                                                ...
                                                                <td style="text-align:center;">
                                                                    <?php if(!Auth::guard('profile')->user()): ?>
                                                                        <a onclick="placeOrder('<?php echo e($products['id']); ?>','<?php echo e(number_format($priceList['flex'], 2)); ?>','Flex');"
                                                                ...
                                                                <td style="text-align:center;">
                                                                    <?php if(!Auth::guard('profile')->user()): ?>
                                                                        <a onclick="placeOrder('<?php echo e($products['id']); ?>','<?php echo e(number_format($priceList['expedited'], 2)); ?>','Expedited');"
                                                                            href="#"
                                                                            class="btn btn-warning button-y"><strong>Select
                                                                                Expedited</strong></a>
                                                                    <?php else: ?>
                                                            ...
                                                            <tr class="mobile-tr-boder">
                                                                ...
                                                                <td style="text-align:center;">
                                                                    <a onclick="placeOrder('<?php echo e($products['id']); ?>','<?php echo e(number_format($priceList['standard'], 2)); ?>','Standard')"
                                                                        ...
                                                                        <strong><?php echo e("$" . number_format($priceList['standard'] * Session::get('quantity'), 2)); ?></strong></a>
                                                                </td>
                                                            </tr>
                                                            <tr class="mobile-tr-boder">
                                                                <td scope="row">
                                                                ...
                                                                <td style="text-align:center;">
                                                                    <a onclick="placeOrder('<?php echo e($products['id']); ?>','<?php echo e(number_format($priceList['flex'], 2)); ?>','Flex')"
                                                                        ...
                                                                        <strong><?php echo e("$" . number_format($priceList['flex'] * Session::get('quantity'), 2)); ?></strong>
                                                                    </a>
                                                                </td>
                                                            </tr>
                                                            <tr class="mobile-tr-boder">
                                                                ...
                                                                <td style="text-align:center;">
                                                                    <a onclick="placeOrder('<?php echo e($products['id']); ?>','<?php echo e(number_format($priceList['expedited'], 2)); ?>','Expedited')"
                                                                        ...
                                                                        <strong><?php echo e("$" . number_format($priceList['expedited'] * Session::get('quantity'), 2)); ?></strong>
                                                                    </a>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-6">
                                            <a type="button" class="btn btn-fo-back  btn-prev col-md-2 col-sm-4 col-xs-12"
                                                href="<?php echo e(url('/customers').'?tab_step=2'); ?>">Back</a>
                                        </div>
