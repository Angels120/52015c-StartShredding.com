                                                                    ...
                                                                    <div class="row column-seperation">
                                                                        <div class="col-lg-12"> 
                                                                            ...
                                                                            <div class="credit-derails">
                                                                                ...
                                                                                <form action="{{ action('IndexController@updateCardDetails',['customerid' => $user->id]) }}"
                                                                                    ...
                                                                                    {{ csrf_field() }}
                                                                                        <div class="bg-contrast-lower padding-30 b-rad-lg credit-card">
                                                                                            ...
                                                                                            <div class="form-group form-group-default required m-t-25">
                                                                                                ...
                                                                                                <input type="text" class="form-control" name="card_holder_name" value="{{$card_details->card_holder_name}}" placeholder="Name on the card" required>
                                                                                            </div>
                                                                                            <div class="form-group form-group-default required">
                                                                                                <label>Card number</label>
                                                                                                <!--input type="text" class="form-control" placeholder="8888-8888-8888-8888" required-->
                                                                                                <input type="text" class="form-control card-no" name="card_number" value="{{$card_details->card_number}}" placeholder="8888 8888 8888 8888" size="18" id="cr_no" minlength="19" maxlength="19" required>
                                                                                            </div>
                                                                                                ...
                                                                                                <div class="row no-margin">
                                                                                                    ...
                                                                                                    <div class="col-md-2 p-0">
                                                                                                        ...
                                                                                                        <div class="form-group required">
                                                                                                            <input class="form-control mh-55 m-25 sm-ml-0" type="password" value="{{$card_details->ccv}}" name="ccv" placeholder="000" size="1" minlength="3" maxlength="3" required>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
