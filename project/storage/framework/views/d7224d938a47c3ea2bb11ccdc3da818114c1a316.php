...
<style>
    ...
    .free-cleaning {
        /* background-image: url('<?php echo e(url("assets/img/tilead_easy.png")); ?>'); */
        
        position: relative;
    }

    .drop-off {
        /* background-image: url('<?php echo e(url("/assets/img/tilead_GiftCards.png")); ?>'); */
    ...
    .whyube {
        /* background-image: url('<?php echo e(url("assets/img/tilead_whyube.png")); ?>'); */
      
        position: relative;
    }

    .welcome {
        /* background-image: url('<?php echo e(url("assets/img/tile_welcome.png")); ?>'); */
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-4" id="column-change">
                ...
                <img src="<?php echo e(url('/assets/img/welcome-bg.jpg')); ?>" class="responsive" />
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <div class="col-lg-12 col-md-3 col-sm-5 col-xs-12 input-group" style="z-index:1">
                                    <form class="example" action="<?php echo e(route('user.get.address')); ?>" method="post">
                            ...
                            <div class="row">
                                <div class="col-xs-5">
                                    <a href="<?php echo e(url('signin/user')); ?>" type="button" class="btn site-color btn-block">SIGN
                                        IN</a>
                                </div>
                                ...
                                <div class="col-xs-5">
                                    ...
                                    <a href="<?php echo e(url('user/registration')); ?>" type="button"
                ...
                <a href="<?php echo e(url('user-dashboard')); ?>"><img src="<?php echo e(url('/assets/img/tile_welcome.png')); ?>" class="responsive" /></a>
            ...
            <a href="<?php echo e(url('/user/gift-cards')); ?>">
                <div class="col-sm-4" id="column-change">
                    <div class="box drop-off">
                        <img src="<?php echo e(url('/assets/img/tilead_GiftCards.png')); ?>" class="responsive" />
            ...
            <a href="<?php echo e(url('user/refer-friend')); ?>">
                <div class="col-sm-4" id="column-change">
                    <div class="box free-cleaning">
                    <img src="<?php echo e(url('/assets/img/tilead_easy.png')); ?>" class="responsive" />
        ...
        <div class="row">
            <div class="col-sm-8" id="column-expanded">
                <div class="row">
                    <?php $__currentLoopData = \App\Category::where('mainid', 6)->where('role','sub')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $childmenu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-sm-3">
                        <div class="category-item">
                            <a href="<?php echo e(url('/category')); ?>/<?php echo e($childmenu->slug); ?>">
                                <div class="category-img">
                                    
                                    <img
                                        src="<?php echo e(url('/assets/images/categories/') . '/' . $childmenu->feature_image); ?>">
                                </div>
            ...
            <div class="col-sm-4" id="column-change">
                ...
                <img src="<?php echo e(url('/assets/img/tilead_whyube.png')); ?>" class="responsive" />
