            ...
            <div class="row">
                ...
                <div class="col-sm-5">
                    <div class="newAccount-area">
                        ...
                        <?php endif; ?>
                        <?php if($errors->has('giftcode')): ?>
                        <div class="alert alert-danger alert-dismissable">
                            <strong>* <?php echo e($errors->first('giftcode')); ?></strong>
                        </div>
                        <?php endif; ?>
                        <form action="<?php echo e(route('user.reg.submit')); ?>" method="post">
                            ...
                            <div class="row">
                                <div class="col-sm-6 form-group">
                                    ...
                                    <input class="form-control" value="<?php echo e(old('first_name')); ?>" type="text"
                                        name="first_name" id="first_name" required autocomplete="off">
                                </div>
                                <div class="col-sm-6 form-group">
                                    <label for="reg_name">Last Name <span>*</span></label>
                                    <input class="form-control" value="<?php echo e(old('last_name')); ?>" type="text"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 form-group">
                                    ...
                                    <input id="yourphone" class="form-control" value="<?php echo e(old('phone')); ?>" type="text"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 form-group">
                                    ...
                                    <input id="pac-input" class="form-control" type="text"
                                        placeholder="Enter a location" value="<?php echo e(Session::get('address')); ?>" required autocomplete="off">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6 form-group">
                                    <label for="unit_no">Suite/Unit#</label>
                                    <input class="form-control" value="<?php echo e(old('unit_no')); ?>" type="number" name="unit_no"
                                        id="unit_no"  autocomplete="off">
                                </div>
                                <div class="col-sm-6 form-group">
                                    <label for="buzz_code">Buzz Code</label>
                                    
                                    <input id="buzz_code" class="form-control" value="<?php echo e(old('buzz_code')); ?>" type="number"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 form-group">
                                    ...
                                    $code = request()->get('ref');
                                     ...
                                     ?>
                                    <input class="form-control" value="<?php echo e($code); ?>" type="text" name="signup_code"
                                        id="signup_code">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 form-group">
                                    <input class="form-control" value="<?php echo e(!$errors->has('giftcode') && request()->has('giftcode') ? request()->get('giftcode') : null); ?>" type="text" name="giftcode"
                                        id="giftcode" <?php echo e(!$errors->has('giftcode') && request()->has('giftcode') ? "" : null); ?>>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12 text-right">
                                        <a href="<?php echo e(url('user/login')); ?>">Already Have Account?</a>
                                    </div>
                                </div>
                            </div>
