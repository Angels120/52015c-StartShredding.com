                        ...
                        <div class="col-xs-9">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="analytics">
                                    ...
                                    <form method="POST" action="<?php echo action('SeoToolsController@update',['id' => $tools->id]); ?>" class="form-horizontal form-label-left" novalidate>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <textarea rows="10" class="form-control" name="google_analytics" placeholder="Google Analytics Script" required="required"><?php echo e($tools->google_analytics); ?></textarea>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane" id="metatags">
                                    ...
                                    <div class="ln_solid"></div>
                                    <form method="POST" action="<?php echo action('SeoToolsController@update',['id' => $tools->id]); ?>" id="meta_form" class="form-horizontal form-label-left" novalidate>
                                        <?php echo e(csrf_field()); ?>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <textarea rows="10" class="form-control" name="meta_keys" placeholder="Website Meta Keywords (Seperated By Commas)" required="required"><?php echo e($tools->meta_keys); ?></textarea>
                                            </div>
                                        </div>
