        ...
        <?php if(Session::get('error') != ""): ?>
            ...
            <div  class="col-xs-12">
                <div class="inner">
                    ...
                    <form method="post" action="<?php echo e(route('vendor.order_job_status')); ?>" id="main-form" class="bg-white basic-form horizontal-form col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="text-center col-xs-12">
                                          <ul class="table-foot-btn excel-btn">
                                                <strong>
                                                    ...
                                                    <li>
                                                    <a class="bulkEmailTrigger bigBtnhref sendMail" title="Email" href='<?php echo e(route("orders_details_mail",$order->id)); ?>'><i class="fa fa-envelope"></i></a>
                                                    </li>
                                                </strong>
                                            </ul>
                            </div>
