<?php $__env->startSection('content'); ?>
    ...
    <div class="page-title row">
        <h2>Template: <?php echo e($orderTemplate->name); ?></h2>
        <div style="float: right;">
            <a class="btn btn-info right" href="/vendor/order-template/<?php echo e($orderTemplate->id); ?>/edit"><i class="glyphicon glyphicon-edit"></i> Edit Template</a>
            <a class="btn btn-warning right" href="/vendor/order-template-history/<?php echo e($orderTemplate->client_id); ?>/<?php echo e($orderTemplate->id); ?>"><i class="glyphicon glyphicon-record"></i> Order History</a>
        </div>
    </div>
    ...
    <div class="bg-white row">
        <div class="panel-body-custom tableContainParent panel col-md-12 col-lg-12 col-sm-12 left-tab">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="mt-2 col-md-4">
                            ...
                            <p><?php echo e($orderTemplate->id); ?></p>
                        </div>

                        <div class="mt-2 col-md-4">
                            <p><strong>Name:</strong></p>
                            <p><?php echo e($orderTemplate->name); ?></p>
                        </div>

                        <div class="mt-2 col-md-4">
                            <p><strong>Customer:</strong></p>
                            <p>
                                <a href="/vendor/customer/<?php echo e($orderTemplate->client_id); ?>"><?php echo e($orderTemplate->client->first_name." ".$orderTemplate->client->last_name); ?></a>
                            </p>
                        </div>
                        <div class="mt-2 col-md-4">
                            <p><strong>Job Type:</strong></p>
                            <p><?php echo e($job_type->TYPE_NAME); ?></p>
                        </div>

                        <div class="mt-2 col-md-4">
                            <p><strong>Average Service Time:</strong></p>
                            <p><?php echo e($orderTemplate->avg_service_time); ?>&nbsp;minutes</p>
                        </div>

                        <div class="mt-2 col-md-4">
                            <p><strong>Account Manager:</strong></p>
                            <p><?php echo e($accountManager->FULL_NAME); ?></p>
                        </div>

                        <div class="mt-2 col-md-4">
                            <p><strong>Repeat:</strong></p>
                            <p><?php echo e($orderTemplate->repeat); ?></p>
                        </div>
                        <?php 
                       ...
                       ?>
                        <div class="mt-2 col-md-4">
                            ...
                            <p><?php echo e($schedule_from); ?></p>
                        </div>

                        <div class="mt-2 col-md-4">
                            <p><strong>Days Allowed:</strong></p>
                            <p><?php echo e($orderTemplate->daysAllowed()); ?></p>
                        </div>

                        <div class="mt-2 col-md-4">
                            <p><strong>Special Notes:</strong></p>
                            <p><?php echo e($orderTemplate->special_notes); ?></p>
                        </div>

                        <div class="mt-2 col-md-4">
                            <p><strong>Is Active:</strong></p>
                            <p><?php echo e($orderTemplate->is_active==1? 'Yes':'No'); ?></p>
                        </div>

                        <div class="mt-2 col-md-4">
                            <p><strong>PO/CRO Number:</strong></p>
                            <p><?php echo e((isset($orderTemplate->po_cro_no)?$orderTemplate->po_cro_no:'N/A')); ?></p>
                        </div>

                        <div class="mt-2 col-md-4">
                            <p><strong>Payment Method:</strong></p>
                            <p><?php echo e($orderTemplate->payment_method); ?></p>
                        </div>
                            ...
                            <div class="panel-body-custom tableContainParent panel col-md-12 col-lg-12 col-sm-12 left-tab">
                                <div class="table-responsive">
                                    ...
                                    <form method="POST" action="/vendor/template-product">
                                        ...
                                        <input type="hidden" name="template_id" value="<?php echo e($orderTemplate->id); ?>"/>
                                        <table data-text="customers" id="example" cellpadding="0" cellspacing="0"
                                            ...
                                            $total=0.00;
                                            ?>
                                            <?php $__currentLoopData = $orderTemplateItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $orderTemplateItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr id="existingRow<?php echo e($orderTemplateItem->id); ?>">
                                                    <td>
                                                        <select name="existingitem[<?php echo e($orderTemplateItem->id); ?>][product_id]"
                                                                id="existingitem" style="width:100%">
                                                            <option value="">Select Product</option>
                                                            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($key); ?>"
                                                                        <?php if($key == $orderTemplateItem->product_id): ?> selected="selected" <?php endif; ?>>
                                                                    <?php echo e($value); ?>
                                                        ...
                                                        <input type="hidden" id="productprice"
                                                               value="<?php echo e(App\Product::getPriceById($orderTemplateItem->product_id)); ?>"
                                                               name="existingitem[<?php echo e($orderTemplateItem->id); ?>][product_price]"/>
                                                    </td>
                                                    <td><input type="text" value="<?php echo e((!empty($orderTemplateItem->item_note))?$orderTemplateItem->item_note:App\Product::getShortDescriptionById($orderTemplateItem->product_id)); ?>"
                                                               name="existingitem[<?php echo e($orderTemplateItem->id); ?>][item_note]"
                                                               class="item_note" style="width:100%"/>
                                                    </td>
                                                    <td><input type="number" value="<?php echo e($orderTemplateItem->qty); ?>"
                                                               name="existingitem[<?php echo e($orderTemplateItem->id); ?>][qty]"
                                                               maxlength="5" size="5"/>
                                                    </td>
                                                    <td>
                                                        $<input type="text" id="itemprice"
                                                                value="<?php echo e(number_format((float)($orderTemplateItem->base_price), 2, '.', '')); ?>" class="price"
                                                                name="existingitem[<?php echo e($orderTemplateItem->id); ?>][base_price]"
                                                                maxlength="8" size="8"/>
                                                    </td>
                                                    <td>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="genNextMonthForm" action="/vendor/order-template/generate" method="POST">
                                <input type="hidden" name="order_template_id" value="<?php echo e($orderTemplate->id); ?>">
                    ...
                    <div class="modal-content" style="text-align: center;">
                        ...
                        <div class="modal-body">
                            <form id="genSingleDateForm" action="/vendor/order-template/generate" method="POST">
                                ...
                                <input type="text" name="date" class="w-50" value="<?php echo e(date('m/d/Y')); ?>"/>
            ...
            <a href="/vendor/customer/<?php echo e($orderTemplate->client_id); ?>" class="btn btn-success float-right my-2">Back To Customer Account</a>
        </div>
    </div>
