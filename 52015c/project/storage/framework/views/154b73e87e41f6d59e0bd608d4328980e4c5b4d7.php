                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                window.location.replace(
                                    "<?php echo e(url('/customers/products/')); ?>/" +
                                    product_id);
                    ...
                    <div class="row">
                        <div
                            ...
                            <div class="step-content">
                                ...
                                <div class="step-pane step1 <?php if($_GET['tab_step'] == 2): ?> hide <?php endif; ?>">
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <ul id="result" class="serachwrap" style="display: block;">
                                                        <li title="<?php echo e($fullAddress); ?>" id="onload_click"><i
                                                                class="fa fa-map-marker"></i><?php echo e($fullAddress); ?></li>
                                                    </ul>
                                                    <?php } ?>
                                                    <script type="text/javascript">
                                                        window.onload = function() {
                                                            ...
                                                            var onload_product_id = '<?php echo e($onload_product_id); ?>';
                                ...
                                <!-- Step 2 Start -->
                                <div class="step-pane step2 hide <?php if($_GET['tab_step'] == 2): ?> show <?php endif; ?>" >
                                                            ...
                                                            <div style="border: 1px solid #000;">
                                                                <?php if($pro->title): ?>
                                                                    ...
                                                                    <div class="post-card-cover">
                                                                        ...
                                                                        <?php if($pro->feature_image): ?>
                                                                            <img style="width:270px;height:200px"
                                                                                src="<?php echo e(URL::asset('assets/images/products/' . $pro->feature_image)); ?>">
                                                                        <?php else: ?>
                                                                            <img style="width:270px;height:200px"
                                                                                src="<?php echo e(URL::asset('shop_assets/images/placeholder-image.png')); ?>">
                                                                        <?php endif; ?>
                                                                    </div>
                                                                    <script>
                                                                        $(function() {
                                                                            $("#AddToCart<?php echo e($key); ?>").on('click', function() {
                                                                                var product_id = $('.product_<?php echo e($key); ?>').val();
                                                                    ...
                                                                    <form action="<?php echo e(route('home.order.addSession')); ?>"
                                                                        method="post">
                                                                        <?php echo e(csrf_field()); ?>
                                                                            ...
                                                                            <div class="cart-product-count">
                                                                                <div class="input-group">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <input type="hidden"
                                                                                            name="product_id"
                                                                                            value="<?php echo e($pro->id); ?>">
                                                                                        <input
                                                                                            class="number quantity_<?php echo e($key); ?> form-control input-number btn-default-focus"
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <img class="p-r-40 m-t-10 xs-image-responsive-height sm-no-padding"
                        src="<?php echo e(url('home_assets/images/color_wheel.png')); ?>" alt="">
                </div>
            </div>
