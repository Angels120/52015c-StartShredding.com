            ...
            <div class="row" id="main">
                ...
                <div class="go-title">
                    <div class="pull-right">
                        <a href="<?php echo url('admin/customers'); ?>" class="btn btn-default btn-back"><i class="fa fa-arrow-left"></i> Back</a>
                    </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div id="response"></div>
                        <form method="POST" action="<?php echo action('CustomerController@sendemail'); ?>" class="form-horizontal form-label-left">
                            <?php echo e(csrf_field()); ?>

                            <input type="hidden" value="<?php echo e($customer->email); ?>" name="to">
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">To:<span class="required">*</span>

                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" class="form-control col-md-7 col-xs-12" name="name" value="<?php echo e($customer->name); ?>" disabled type="text">
                                </div>
                            </div>
                            <div class="item form-group">
