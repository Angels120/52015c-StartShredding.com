                    ...
                    <div class="inner" style="width: 100%;">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
									<form method="post" action="<?php echo e(route('vendor.order_add')); ?>" id="main-form" class="bg-white basic-form horizontal-form col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="step-pane">
                                <div class="col-sm-12 col-xs-12 col-md-12 service-block">
                                    ...
                                    <div class="text-left col-xs-12">
                                        <a href="<?php echo e(route('vendor.customer')); ?>" data-prev="step1" class="btn btn-success btn-next">Back<i class="icon-arrow-left"></i></a>
