...
<head>
    ...
    <link href="<?php echo e(URL::asset('assets/vendor/css/custom.css')); ?>" rel="stylesheet">
                  ...
                  <div class="line-entry">
                     ...
                     <div class="header-top-entry increase-icon-responsive login">
                     	 <div class="dropdown">
                            ...
                            <li>
                            <a href="<?php echo url('vendor/vendorpassword'); ?>">
               ...
               <div class="nav-overflow">
                  <nav> 
                     <ul>
                        ...
                        <li class="simple-list"><a href="<?php echo url('vendor/products'); ?>" class="">Products</a></li>
                        ...
                        <li class="simple-list"><a href="<?php echo url('vendor/order-template'); ?>">Repeat Jobs</a></li>
                     </ul>
                     <div class="clear"></div>
                  </nav>
