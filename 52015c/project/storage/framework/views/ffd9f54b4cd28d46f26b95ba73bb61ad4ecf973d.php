...
<meta id="p" name="csrf_token" content="<?php echo e(csrf_token()); ?>" />
    ...
    <div class="sidebar-menu">
        ...
        <ul class="menu-items">
            <li class="m-t-30" <?php echo (Request::is('user-dashboard.index') ? 'class="active"' : '' ); ?>>
                <a href="<?php echo e(route("user-dashboard.index")); ?>" class="detailed">
                    <span class="title">My Dashboard</span>
                    <!--  -->
                </a>
                <span class="icon-thumbnail"><i class="fa fa-tachometer" aria-hidden="true"></i></span>
            </li>
            <li <?php echo (Request::is('user-orders') ? 'class="active"' : '' ); ?>>
                <a href="<?php echo e(route("user.myorders")); ?>" class="detailed">
                    <span class="title">My Orders</span>
                </a>
                <span class="icon-thumbnail"><i class="fa fa-first-order" aria-hidden="true"></i></span>
            </li>
            <li <?php echo (Request::is('user/account-details') ? 'class="active"' : '' ); ?>>
            ...
            <li <?php echo (Request::is('user-gift-cards') ? 'class="active"' : '' ); ?>>
                <a href="<?php echo e(route("user-gift-cards")); ?>" class="detailed">
                    <span class="title">Gift Cards</span>
                </a>
                <span class="icon-thumbnail"><i class="fa fa-gift"></i></span>
            </li>
            <li <?php echo (Request::is('user/refer-friend') ? 'class="active"' : '' ); ?>>
                <a href="<?php echo e(route("user.refer-friend")); ?>" class="detailed">
                    <span class="title">Refer a Friend</span>
                </a>
                <span class="icon-thumbnail"><i class="fa fa-location-arrow" aria-hidden="true"></i></span>
            </li>
            <li <?php echo (Request::is('user/product-favourite') ? 'class="active"' : '' ); ?>>
    ...
    <div class="header ">
        ...
        <div class="mobile-set">
            <div class="brand inline logo-with-dashboad  ">
                ...
                <div class="brand-logo">
                    <a href="<?php echo e(url('/')); ?>"><img src="http://www.ubeclean.com/assets/img/ube_logo_ig.png"
                            class="img-responsive" /></a>
                </div>
                <div class="my-dashboard">
                    <a href="<?php echo e(route("user-dashboard.index")); ?>"><img class="dashboard"
                            src="<?php echo e(url('/assets/img/logo_mydashboard.png')); ?>"></a>
                </div>
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="pull-left p-r-10 fs-14 d-lg-block d-none logged-username">
                <span><?php echo e(Auth::guard('profile')->user()->first_name); ?></span>
                <span><?php echo e(Auth::guard('profile')->user()->last_name); ?></span>
            </div>
            <div class="dropdown pull-right d-lg-block d-none">
                <button class="profile-dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true"
                    aria-expanded="false">
                    <span class="thumbnail-wrapper d32 circular inline">
                        <img src="<?php echo e(URL::asset('/assets/img/default-user.jpg')); ?>" alt=""
                            data-src="<?php echo e(URL::asset('/assets/img/default-user.jpg')); ?>"
                            data-src-retina="<?php echo e(URL::asset('/assets/img/default-user.jpg')); ?>" width="32" height="32">
                    </span>
                </button>
                <div class="dropdown-menu dropdown-menu-right profile-dropdown" role="menu">
                    <a href="<?php echo e(route("user.account-details")); ?>" class="dropdown-item">
                        Account
            ...
            <div class="pull-right d-lg-block d-none balance-summery">
                <span>Balance :</span>
                <span><?php echo e($settings[0]->currency_sign); ?>

                    <?php echo e(number_format(Auth::guard('profile')->user()->balance, 2)); ?></span>
            </div>
