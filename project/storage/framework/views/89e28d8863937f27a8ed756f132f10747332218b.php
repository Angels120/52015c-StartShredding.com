	...
	<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 left-table medium-right stick-able">
		<div class="bg-yellow">
			<div class="sale-summary">
				...
				<div class="sales">
					<p><b>Sales:</b> <a href="javascript:;"><?php echo e($settings[0]->currency_sign); ?><?=round($SaleSummary,2)?></a></p>
			...
			<div class="bg-white">
				<div class="row">
					<div class="col-md-12 col-xs-12">
						<form action="<?php echo url('vendor/action/request-pickup'); ?>" method="post">
								...
								<div class="panel-body">
											...
											if(count($pendingOrders)>0){
												foreach ($pendingOrders as $orders) {
													...
													<tr>
														...
														<td><a href="<?php echo url('vendor/details/'.$orders->orderid); ?>"><?=$orders->orderid?></a></td>
									...
									<div class="table-btn text-right">
										<ul class="table-foot-btn">
											<li><a href="<?php echo url('vendor/vieworders/active'); ?>">View All</a></li>
							...
							<div class="panel panel-default">
								...
								<?php echo e(csrf_field()); ?>  
									...
									<div class="panel-body">
										...
										<div class="table-btn text-right">
											<ul class="table-foot-btn">
												<li><a href="<?php echo url('vendor/vieworders/in-transit'); ?>">View All</a></li>
												<li class="selectUnchecked"><a href="javascript:;">Select All</a></li>
												<li class="deselectChecked hide"><a href="javascript:;">Deselect</a></li>
							...
							<div class="panel panel-default">
								...
								<form action="<?php echo url('vendor/action/batch-notify'); ?>" method="post">
									...
									<div class="panel-body">
													...
													if(count($pendingOrders)>0){
														foreach ($pendingOrders as $orders) {
															...
															<tr>
																...
																<td><?=Config::get($statusKey)?></td>
																<td><a href="#">SMS</a> | <a href="<?php echo url('vendor/action/send-notification'); ?>?id=<?=$orders->id?>">Email</a></td>
															</tr>
															<?php
															}
														}
										...
										<div class="table-btn text-right">
											<ul class="table-foot-btn"> 
												<li><a href="<?php echo url('vendor/vieworders/completed'); ?>">View All</a></li>
												<li class="selectUnchecked"><a href="javascript:;">Select All</a></li>
												<li class="deselectChecked hide"><a href="javascript:;">Deselect</a></li>
