    ...
    <div class="relative">
        ...
        <div class="pull-left">
            ...
            <div class="header-inner m-l-35">
                <!-- BEGIN LOGO -->
                <img src="<?php echo e(URL::asset('assets_new/assets/images/logo.png')); ?>" width="190" height="40"
                     data-src-retina="<?php echo e(URL::asset('assets_new/assets/images/logo.png')); ?>"
                     class="logo" alt="">
                <img src="<?php echo e(URL::asset('assets_new/assets/images/logo.png')); ?>" width="190" height="40"
                     data-src-retina="<?php echo e(URL::asset('assets_new/assets/images/logo.png')); ?>" class="alt" alt="">
            </div>
        </div>
                    ...
                    <div class="header-inner">
                        <ul class="menu no-padding">
                            ...
                            <?php if(Auth::guard('profile')->guest()): ?>
                                <li>
                                    <a href="<?php echo e(route('home.user')); ?>" data-text="Login" class="p-r-0">Login</a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('home.register')); ?>" data-text="Sign Up" class="p-r-0">Sign Up</a>
                                </li>
                            <?php else: ?>
                                <li>
                                    <a href="<?php echo e(route('home.logout')); ?>" data-text="Logout" class="p-r-0">Logout</a>
                                </li>
                            <?php endif; ?>
                            <li class="open">
