            ...
            <div class="row" id="main">
                ...
                <div class="go-title">
                    <div class="pull-right">
                        <a href="<?php echo url('vendor/products'); ?>" class="btn btn-default btn-back"><i class="fa fa-arrow-left"></i> Back</a>
                    </div>
                    <h3>Add Product</h3>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div id="response"></div>
                        <form method="POST" action="<?php echo action('VendorProductsController@store'); ?>" class="form-horizontal form-label-left" enctype="multipart/form-data">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <textarea name="short_description" id="description" class="form-control" maxlength="30" rows="2"></textarea>
                                </div>
                            </div>
                            <div class="item form-group">
