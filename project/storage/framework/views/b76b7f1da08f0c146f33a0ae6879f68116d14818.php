...
<link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('project/public/clientorder-css/bootstrap.min.css')); ?>"/>
<link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('project/public/clientorder-css/font-awesome.min.css')); ?>"/>
<link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('project/public/clientorder-css/style.css?v=1.2')); ?>"/>
...
<script type="text/javascript" src="<?php echo e(URL::asset('project/public/clientorder-js/jquery1.11.3.min.js')); ?>"  ></script>
<script type="text/javascript" src="<?php echo e(URL::asset('project/public/clientorder-js/bootstrap3.3.4.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('project/public/clientorder-js/picker.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('project/public/clientorder-js/picker.date.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('project/public/clientorder-js/validate.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('project/public/clientorder-js/validate_init.js?v=1.0')); ?>"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('project/public/clientorder-js/function.js')); ?>"></script>
                    ...
                    <div class="boxed no-padding">
                        ...
                        <div class="inner">
                            ...
                            <div class="step-content">
                              <form method=""  enctype="multipart/form-data" action="<?php echo e(route('clientorder.store')); ?>" name="clientorderform" id="main-form" class="basic-form horizontal-form col-md-12 col-sm-12 col-xs-12">
                				<!-- Step 1 Start -->
