...
/*
     @media  screen and (min-width: 768px) and (max-width: 991px) {
        ...
        .navbar-inverse {
            border-color: #090909;
            background-image: url('<?php echo e(url('assets/img/51096b - menu_bkg.png')); ?>');
            ...
            <div class="row mobile-menu">
                ...
                <div class="col-md-6 text-center">
                    <a href="#!" target="_self" class="navbar-brand mobileshow" href="#" id="logo-uBe"><img
                            src="<?php echo e(url('/assets/img/ube_logo_ig.png')); ?>"></a>
                </div>
                <div class="col-md-4">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <div class="row">
                ...
                <a href="<?php echo e(url('/')); ?>" target="_self"> <img class="homelogo"
                            src="<?php echo e(url('/assets/img/51096b - logo_menu.png')); ?>"></a>
                </div>
                <div class="col-sm-6 col-md-4" id="tablet-nav-responsive">
                    <div id="mobileNav" class="mobileshow">
                        <li class="simple-list">
                            <a href="<?php echo e(url('/')); ?>" target="_self"><span class="title">Home</span></a>
                        </li>
                        <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($menu->name === "Dry Clean and Laundry"): ?>
                        <li class="full-width-columns">
                            <a href="<?php echo e(url('/category')); ?>/<?php echo e($menu->slug); ?>">SHOP BY CATEGORY</a>
                            ...
                            <div class="submenu">
                                ...
                                <div class="product-column-entry">
                                    <div class="submenu-list-title"><a href="<?php echo e(url('/category')); ?>/<?php echo e($submenu->slug); ?>"
                                            style="color:#2e2e2e; font-size:13px;"><?php echo e($submenu->name); ?></a><span
                                    ...
                                    <div class="description toggle-list-container">
                                        <ul class="list-type-1">
                                            ...
                                            <li class="full-width-columns" style="border-bottom: 0;"><a
                                                    href="<?php echo e(url('/category')); ?>/<?php echo e($childmenu->slug); ?>"
                                                    style="color:#666; font-size: 12px; font-weight: 600; text-transform: capitalize;"><?php echo e($childmenu->name); ?></a>
                                            </li>
                        ...
                        <!-- <li class="simple-list">
                            <a href="<?php echo e(url('/deals')); ?>" target="_self"><span class="title">Deals</span></a>
                        </li> -->
                        <li class="simple-list">
                            <a href="<?php echo e(url('/buy-credits')); ?>" target="_self"><span class="title">Buy
                                    Credits</span></a>
                        </li>
                        <!-- <li class="simple-lists">
                            <a href="<?php echo e(url('/locations')); ?>" target="_self"><span class="title">Locations</span></a>
                        </li> -->
                        <li class="simple-lists contact">
                            <a href="<?php echo e(url('/rewards')); ?>" target="_self"><span class="title">Rewards</span></a>
                        </li>
                        
                        <li class="simple-lists">
                            <a href="<?php echo e(route('user-dashboard.index')); ?>">
                                <span class="title">Order History</span>
                            </a>
                        </li>
                        <li class="simple-lists">
                            <a href="<?php echo e(route('user.account-details')); ?>" class="title">
                                <span class="title">My Account</span>
                            </a>
                        </li>
                        <li class="simple-lists">
                            <a href="<?php echo e(route('user-dashboard.index')); ?>" class="title">
                                <span class="title">My orders</span>
                            </a>
                        </li>
                        <li class="simple-lists">
                            <a href="<?php echo e(route("user.product-favourite")); ?>" class="detailed">
                        ...
                        <div id="sns_custommenu" class="visible-md visible-lg">
                            <ul class="mainnav">
                                ...
                                <li class="level0 nav-3 no-group drop-submenu12">
                                    ...
                                    <a class="menu-title-lv0" id="homelink" href="<?php echo e(url('/')); ?>" target="_self"><span
                                            class="title"><?php echo e($language->home); ?></span></a>
                                    
                                </li>
                                <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($menu->name === "Dry Clean and Laundry"): ?>
                                <li class="level0 nav-1 no-group drop-submenu12">
                                    <!-- <a class="menu-title-lv0" href="<?php echo e(url('/category')); ?>/<?php echo e($menu->slug); ?>"><span class="title"><?php echo e($menu->name); ?></span></a> -->
                                    <a class="menu-title-lv0" href="<?php echo e(url('/category')); ?>/<?php echo e($menu->slug); ?>"><span
                                            class="title">SHOP
                                            BY
                                            CATEGORY</span></a>
                                    <?php if(\App\Category::where('mainid',$menu->id)->where('role','sub')->count()
                                    >0): ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3 col-md-4">
                                                <h6 class="title menu1-2-5"><a
                                                        href="<?php echo e(url('/category')); ?>/<?php echo e($submenu->slug); ?>"><?php echo e($submenu->name); ?></a><span
                                                        class="toggle-list-button"></span></h6>
                                                <div class="wrap_submenu">
                                                    <ul class="level1">
                                                        <?php $__currentLoopData = \App\Category::where('subid',$submenu->id)->where('role','child')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $childmenu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li class="level2 nav-1-3-16 first"><a class=" menu-title-lv2"
                                                                href="<?php echo e(url('/category')); ?>/<?php echo e($childmenu->slug); ?>"><?php echo e($childmenu->name); ?></a>
                                                        </li>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </ul>
                                                </div>
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                  <!-- <div class="wrap_dropdown fullwidth">
                                        <div class="row">
                                            <?php $__currentLoopData = \App\Category::where('mainid',$menu->id)->where('role','sub')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $submenu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if(\App\Category::where('subid',$submenu->id)->where('role','child')->count()): ?>
                                            <div class="col-sm-3">
                                                <h6 class="title menu1-2-5"><a
                                                        href="<?php echo e(url('/category')); ?>/<?php echo e($submenu->slug); ?>"><?php echo e($submenu->name); ?></a><span
                                                        class="toggle-list-button"></span></h6>
                                ...
                                <!-- <li class="level0 nav-3 no-group drop-submenu12">
                                    <a class="menu-title-lv0" href="<?php echo e(url('/deals')); ?>" target="_self"><span
                                            class="title">Deals</span></a>
                                  
                                </li> -->
                                <li class="level0 nav-3 no-group drop-submenu12">
                                    <a class="menu-title-lv0" href="<?php echo e(url('/buy-credits')); ?>" target="_self"><span
                                            class="title">Buy
                                            Credits</span></a>
                                </li>
                                <!-- <li class="level0 nav-3 no-group drop-submenu12">
                                    <a class="menu-title-lv0" href="<?php echo e(url('/locations')); ?>" target="_self"><span
                            ...
                            <div class="block-minicart">
                                ...
                                <div class="dropdown" style="float:left;">
                                    ...
                                    <span class="login-a dropbtn" style="margin-top:10px;padding:5px;margin-right:3px;">
                                        ...
                                        <span><a href="<?php echo e(url('user/registration')); ?>"><i class="fa fa-user-plus">
                                                </i><span class="">
                                                    Sign Up </span></a> &nbsp; | &nbsp;</span>
                                        <span><a href="<?php echo e(url('signin/user')); ?>"><i class="fa fa-key"> </i><span class="">
                                                    Login </span></a> &nbsp; | </span>
                                        <?php else: ?>
                                        <span><a href="<?php echo e(route('logout')); ?>"
                                                onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i
                                                    class="fa fa-power-off"> </i><span class="">
                                                    logout </span></a> &nbsp; | &nbsp;</span>
                                        <span>
                                            <a href="<?php echo e(route('user-dashboard.index')); ?>"><i class="fa fa-user"></i>
                                                <span class="title"><?php echo e(Auth::guard('profile')->user()->first_name); ?> &nbsp; $<?php echo e(number_format((float)Auth::guard('profile')->user()->balance, 2, '.', '')); ?> 
                                                </span>
                                            </a>
                                            &nbsp; |
                                    ...
                                    <div class="dropdown-content " style="left:0;">
                                        <a href="<?php echo e(route("user.account-details")); ?>" class="detailed">
                                            <span class="title">My Account</span>
                                        </a>
                                        <a href="<?php echo e(route('user-dashboard.index')); ?>">
                                            <span class="title">My orders</span>
                                            ...
                                            <div class="row actions">
                                                <div class="col-md-6">
                                                    ...
                                                    <a class="button gfont go-to-cart btn-block"
                                                        href="<?php echo e(url('/order-summary')); ?>" style="width: 100%;">Check
                                                        out</a>
                                                    <?php else: ?>
                                                    <a class="button gfont go-to-cart btn-block"
                                                        href="<?php echo e(url('/order-confirm')); ?>" style="width: 100%;">Check
                                                        out</a>
                                                    <?php endif; ?>
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <?php if(!Auth::guard('profile')->user()): ?>
                                                    <a class="button gfont go-to-cart btn-block" href="<?php echo e(url('/cart')); ?>"
                                                        style="width: 100%;">Go
                                                        to
                                                        cart</a>
                                                    <?php else: ?>
                                            ...
                                            <table id="cartProductTable" class="table table-striped"
                                                ...
                                                <tbody id="cartproductList">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <form
                                                                action="<?php echo e(url('/') . '/cartdelete/product/' . $res->product); ?>"
                                                                method="GET">
                                                                <?php echo e(csrf_field()); ?>
                                                ...
                                                <tbody id="cartSummary" class="<?php echo e($cart_result->count() == 0 ? 'hidden' : ''); ?>">
                                                    <tr>
                                                        <td colspan="5">
                                                            <table id="totalTable">
                                                                <tr>
...
and the Janeen Foundation" data-original-title="Make It Count"><img
                                                                                ...
                                                                                src='<?php echo e(url('assets/img/3742-300x300.jpg')); ?>'>Make
