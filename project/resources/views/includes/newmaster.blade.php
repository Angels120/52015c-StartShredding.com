                    ...
                    <div class="product-header-content">
                        ...
                        <div class="line-entry">
                            ...
                            <div class="header-top-entry increase-icon-responsive login">
                                <a href="{{url('/signin/vendor')}}" class="title"><i class="fa fa-group"></i> <span>{{$language->vendor}}</span></a>
                            </div>
                            <div class="header-top-entry increase-icon-responsive login">
                                <a href="{{url('/signin/plant')}}" class="title"><i class="fa fa-group"></i> <span>{{$language->plant}}</span></a>
                            </div>
                            <div class="header-top-entry increase-icon-responsive login">
                                @if(Auth::guard('profile')->guest())
                                    <a href="{{url('signin/user')}}" class="title"><i class="fa fa-user"></i> <span>{{$language->sign_in}}</span></a>
                                @else
