...
<script>
    $(document).ready(function()
    {
        $('#updateAddress').on('click', function (e) {
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo e(route('home.updateMultipleAddress.popup',['id' => $edit_address->id])); ?>',
                data: {
                    ...
                    <div class="row">
                        <div class="col col-lg-12 form-group-default">
                            <input id="pac-input" class="form-control" type="text" placeholder="Enter a location"
                                   value="<?php echo e($edit_address->address); ?>" autocomplete="off" required><br>
                            <br>
                            <div class="row">
                            ...
                            <input type="hidden" value="<?php echo e($street_no); ?>" name="street" id="street">
                            <input type="hidden" value="<?php echo e($city); ?>" name="city" id="city">
                            <input type="hidden" value="<?php echo e($province); ?>" name="province" id="province">
                            <input type="hidden" value="<?php echo e($country); ?>" name="country" id="country">
                            <input type="hidden" value="<?php echo e($zip); ?>" name="zip" id="zip">
                            <input type="hidden" value="<?php echo e($edit_address->address); ?>" name="address" id="location">
