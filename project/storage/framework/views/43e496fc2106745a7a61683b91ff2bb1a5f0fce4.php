                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-12">
                            <ul class="nav nav-tabs tabs-left">
                                ...
                                <li class=""><a href="#delivery" data-toggle="tab" aria-expanded="false">Delivery Fee</a>
                                </li>
                                <li class=""><a href="#donation_amount" data-toggle="tab" aria-expanded="false">Donation Amount</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="tab-content">
                                    ...
                                    <form method="POST" action="settings/logo" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <img class="col-md-6" src="../assets/images/logo/<?php echo e($setting[0]->logo); ?>">
                                            </div>
                                ...
                                <div class="tab-pane" id="favicon">
                                    ...
                                    <form method="POST" action="settings/favicon" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <img class="col-md-3" src="../assets/images/<?php echo e($setting[0]->favicon); ?>">
                                            </div>
                                ...
                                <div class="tab-pane" id="website">
                                    ...
                                    <form method="POST" action="settings/title" class="form-horizontal form-label-left" id="website_form">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input class="form-control col-md-7 col-xs-12" data-validate-length-range="6" name="title" placeholder="Website Title" required="required" type="text" value="<?php echo e($setting[0]->title); ?>">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <textarea class="form-control col-md-7 col-xs-12" name="popular_tags" placeholder="Popular Tags" required="required"><?php echo e($setting[0]->popular_tags); ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input class="form-control col-md-7 col-xs-12" name="currency_sign" placeholder="Currency Sign" required="required" value="<?php echo e($setting[0]->currency_sign); ?>"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-9">
                                                        <?php if($pageset->slider_status == 1): ?>
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-9">
                                                        <?php if($pageset->category_status == 1): ?>
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-9">
                                                        <?php if($pageset->sbanner_status == 1): ?>
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-9">
                                                        <?php if($pageset->latestpro_status == 1): ?>
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-9">
                                                        <?php if($pageset->featuredpro_status == 1): ?>
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-9">
                                                        <?php if($pageset->subscribe_status == 1): ?>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-9">
                                                        <?php if($pageset->lbanner_status == 1): ?>
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-9">
                                                        <?php if($pageset->popularpro_status == 1): ?>
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-9">
                                                        <?php if($pageset->testimonial_status == 1): ?>
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-9">
                                                        <?php if($pageset->brands_status == 1): ?>
                                ...
                                <div class="tab-pane" id="payment">
                                    ...
                                    <form method="POST" action="settings/payment" class="form-horizontal form-label-left" id="website_form">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input class="form-control col-md-7 col-xs-12" name="paypal" placeholder="Paypal Business" required="required" type="text" value="<?php echo e($setting[0]->paypal_business); ?>">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input class="form-control col-md-7 col-xs-12" name="stripe_key" placeholder="Stripe Key" required="required" type="text" value="<?php echo e($setting[0]->stripe_key); ?>">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input class="form-control col-md-7 col-xs-12" name="stripe_secret" placeholder="Stripe Secret Key" required="required" type="text" value="<?php echo e($setting[0]->stripe_secret); ?>">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input class="form-control col-md-7 col-xs-12" name="mobile_money" placeholder="Mobile Money Instruction" required="required" type="text" value="<?php echo e($setting[0]->mobile_money); ?>">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input class="form-control col-md-7 col-xs-12" name="bank_wire" placeholder="Bank Information" required="required" type="text" value="<?php echo e($setting[0]->bank_wire); ?>">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input class="form-control col-md-7 col-xs-12" name="dynamic_commission"  pattern="[0-9]+(\.[0-9]{0,2})?%?"
                                                       title="Shipping Cost must be numeric or up to 2 decimal places." placeholder="Withdraw Charge(%)" required="required" type="text" value="<?php echo e($setting[0]->dynamic_commission); ?>">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input class="form-control col-md-7 col-xs-12" name="fixed_commission"  pattern="[0-9]+(\.[0-9]{0,2})?%?"
                                                       title="Shipping Cost must be numeric or up to 2 decimal places." placeholder="Withdraw Charge(%)" required="required" type="text" value="<?php echo e($setting[0]->fixed_commission); ?>">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input class="form-control col-md-7 col-xs-12" name="tax"  pattern="[0-9]+(\.[0-9]{0,2})?%?"
                                                       title="Shipping Cost must be numeric or up to 2 decimal places." placeholder="Withdraw Charge(%)" required="required" type="text" value="<?php echo e($setting[0]->tax); ?>">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input class="form-control col-md-7 col-xs-12" name="withdraw_fee"  pattern="[0-9]+(\.[0-9]{0,2})?%?"
                                                       title="Shipping Cost must be numeric or up to 2 decimal places." placeholder="Withdraw Fee" required="required" type="text" value="<?php echo e($setting[0]->withdraw_fee); ?>">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input class="form-control col-md-7 col-xs-12" name="withdraw_charge"  pattern="[0-9]+(\.[0-9]{0,2})?%?"
                                                       title="Shipping Cost must be numeric or up to 2 decimal places." placeholder="Withdraw Charge(%)" required="required" type="text" value="<?php echo e($setting[0]->withdraw_charge); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input class="form-control col-md-7 col-xs-12" name="shipping_cost"  pattern="[0-9]+(\.[0-9]{0,2})?%?"
                                                       title="Shipping Cost must be numeric or up to 2 decimal places." placeholder="Shipping Charge($)" required="required" type="text" value="<?php echo e($setting[0]->shipping_cost); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-9">
                                                        <?php if($setting[0]->stripe_status == 1): ?>
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-9">
                                                        <?php if($setting[0]->mobile_status == 1): ?>
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-9">
                                                        <?php if($setting[0]->cash_status == 1): ?>
                                            ...
                                            <div class="col-md-6">
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-9">
                                                        <?php if($setting[0]->paypal_status == 1): ?>
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-9">
                                                        <?php if($setting[0]->bank_status == 1): ?>
                                ...
                                <div class="tab-pane" id="background">
                                    ...
                                    <form method="POST" action="settings/background" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <img class="col-md-10" src="../assets/images/<?php echo e($setting[0]->background); ?>">
                                            </div>
                                ...
                                <div class="tab-pane" id="about">
                                    ...
                                    <form method="POST" action="settings/about" class="form-horizontal form-label-left" id="about_form">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <textarea rows="10" cols="60" id="aboutpnael" class="form-control" name="about"><?php echo e($setting[0]->about); ?></textarea>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane" id="delivery">
                                    <p class="lead">Delivery Fee</p>
                                    <div class="ln_solid"></div>
                                    <form method="POST" action="settings/delivery-fee" class="form-horizontal form-label-left" id="about_form">
                                        <?php echo e(csrf_field()); ?>

                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="about"> Delivery Fee($) <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="number" name="delivery_fee" value="<?php echo e($setting[0]->delivery_fee); ?>">
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane" id="donation_amount">
                                    <p class="lead">Donation Amount</p>
                                    <div class="ln_solid"></div>
                                    <form method="POST" action="settings/donation-amount" class="form-horizontal form-label-left" id="donation_amount_form">
                                        <?php echo e(csrf_field()); ?>

                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="about"> Donation Amount ($) <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input class="form-control col-md-7 col-xs-12" id="donation_amount" name="donation_amount" value="<?php echo e($setting[0]->donation_amount); ?>" type="number" step="0.01" min="0" onkeypress="return (event.charCode >= 48 &amp;&amp; event.charCode <= 57) || event.charCode == 46  || event.charCode == 0">
                                            </div>
                                        </div>
				    ...
				    <?php $__currentLoopData = $pickups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pickup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				      <tr>
				        <td><?php echo e($pickup->address); ?></td>
				      	<td><a href="<?php echo e(url('/')); ?>/admin/settings/pickup-del/<?php echo e($pickup->id); ?>" class="btn btn-danger btn-xs">Remove</a></td>
				      </tr>
                                ...
                                <div class="tab-pane" id="address">
                                    ...
                                    <form method="POST" action="settings/address" class="form-horizontal form-label-left" id="about_form">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <textarea rows="3" cols="60" class="form-control col-md-7 col-xs-12" name="address" required="required"><?php echo e($setting[0]->address); ?></textarea>
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" name="phone" placeholder="Phone Number" required="required" type="text" value="<?php echo e($setting[0]->phone); ?>">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" name="fax" placeholder="Fax" required="required" type="text" value="<?php echo e($setting[0]->fax); ?>">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" name="email" placeholder="Email Address" required="required" type="text" value="<?php echo e($setting[0]->email); ?>">
                                            </div>
                                        </div>
                                        <div class="ln_solid"></div>
                                        <div class="form-group">
                                ...
                                <div class="tab-pane" id="footer">
                                    ...
                                    <form method="POST" action="settings/footer" class="form-horizontal form-label-left" id="footer_form">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <textarea rows="2" cols="60" id="footerpnael" class="form-control" name="footer" required="required"><?php echo e($setting[0]->footer); ?></textarea>
                                            </div>
                                        </div>
