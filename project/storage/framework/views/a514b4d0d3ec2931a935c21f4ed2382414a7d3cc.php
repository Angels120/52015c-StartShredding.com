            ...
            <div class="col-sm-4 col-sm-offset-2">
                ...
                <div class="order-tracking">
                    ...
                    <div class="trackingnumber">
                        #<?php echo e(session()->get( 'order1' )->order_number); ?>

                        
                    </div>
                    <a href="<?php echo e(route('user.myorders')); ?>">Click to view status</a>
                </div>
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="next-order-area">
                            <div>Get Your Next Order for <span><img src="<?php echo e(url('/assets/img/free.png')); ?>" /></span>
                            </div>
                        </div>
