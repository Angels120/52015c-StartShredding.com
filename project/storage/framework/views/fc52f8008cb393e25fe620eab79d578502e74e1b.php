            ...
            <div class="row" id="main">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <form method="POST" action="<?php echo action('AdminProfileController@update',['id' => $admin->id]); ?>" class="form-horizontal form-label-left" enctype="multipart/form-data">
                            ...
                            <div class="item form-group">
                                ...
                                <span class="col-md-2 col-sm-6 col-xs-12">
                                              <img style="width: 120px; height: 120px;" src="<?php echo e(url('/')); ?>/assets/images/admin/<?php echo e($admin->photo); ?>" id="adminimg" class="img-circle profile_img" alt="Admin Photo">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input class="form-control col-md-7 col-xs-12" name="name" placeholder="Admin Name" value="<?php echo e($admin->name); ?>" required="required" type="text">
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input class="form-control col-md-7 col-xs-12" name="email" placeholder="Admin Email" value="<?php echo e($admin->email); ?>" required="required" type="text">
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input class="form-control col-md-7 col-xs-12" name="phone" placeholder="Admin Phone Number" value="<?php echo e($admin->phone); ?>" required="required" type="text">
                                </div>
                            </div>
