...
<?php $__env->startSection('content'); ?>
    <link rel="stylesheet" href="<?php echo e(URL::asset('assets2/css/summary.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(URL::asset('assets2/css/cart.css')); ?>">
    ...
    <section class="p-b-65 p-t-100 m-t-20">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <form action="<?php echo e(route('home.login.submit')); ?>" method="POST">
                                                                ...
                                                                <div class="form-group">
                                                                    <a href="<?php echo e(route('home.forgotpass')); ?>"
                                                ...
                                                <div id="tabs-1">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <form action="<?php echo e(route('home.register.submit.order')); ?>"
                                                                method="post">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col col-lg-12">
                                                                        ...
                                                                        <input id="pac-input" class="form-control"
                                                                            ...
                                                                            value="<?php echo e($fullAddress); ?>" autocomplete="off"
                                                                            required><br>
                                                                    </div>
                                                                </div>
                                                                <br>
                                                                <div class="row">
                                                                    <div class="col col-lg-12">
                                                                        ...
                                                                        ?>
                                                                        <input type="hidden" value="<?php echo e($latitude); ?>"
                                                                            name="latitude" id="latitude">
                                                                        <input type="hidden" value="<?php echo e($lontude); ?>"
                                                                            name="lontude" id="lontude">
                                                                        <input type="hidden" value="<?php echo e($street_no); ?>"
                                                                            name="street" id="street">
                                                                        <input type="hidden" value="<?php echo e($city); ?>"
                                                                            name="city" id="city">
                                                                        <input type="hidden" value="<?php echo e($province); ?>"
                                                                            name="province" id="province">
                                                                        <input type="hidden" value="<?php echo e($country); ?>"
                                                                            name="country" id="country">
                                                                        <input type="hidden" value="<?php echo e($zip); ?>"
                                                                            name="zip" id="zip">
                                                                        <input type="hidden" value="<?php echo e($fullAddress); ?>"
                                                                    ...
                                                                    <table id="address" hidden>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="slimField"><input
                                                                                    class="field"
                                                                                    value="<?php echo e(old('administrative_area_level_1')); ?>"
                                                            ...
                                                            <input type="hidden" name="latitude" id="latitude"
                                                                value="<?php echo e(Session::get('latitude')); ?>" />
                                                            <input type="hidden" name="logtitude" id="longitude"
                                                                value="<?php echo e(Session::get('lontude')); ?>" />
                                                        ...
                                                        <tbody style="font-size: 12px;">
                                                            <?php $__currentLoopData = $response; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $res): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <tr style="font-weight: 700;">
                                                                    ...
                                                                    <td class="text-left">$<?php echo e(number_format((float) $res->cost, 2, '.', '')); ?>

                                                                    </td>
                                                                    <td class="text-center">$<?php echo e(number_format((float) $res->cost * $res->quantity, 2, '.', '')); ?>
                                                                ...
                                                                <td colspan="5">
                                                                    <table id="totalTable">
                                                                        <tr>
                                                                            ...
                                                                            <td class="text-right">
                                                                                <b>$<?php echo e(number_format((float) $price, 2, '.', '')); ?></b>
                                                                            </td>
                                                                        </tr>
        ...
        Your small micro donation will go towards providing free services and programs for Mental Health.  In addition, this Merchant will also generously match your donation. <br> <br> <a href='<?php echo e(route('home.makeitcount')); ?>' target='_blank' title='test add link'><b style=''>Click Here</b> </a> to learn more about this program
        and the Janeen Foundation" data-original-title="Make It Count">Make It Count <img class='makeitcounticon'
                                                                                        src='<?php echo e(url('assets/img/makeitcounticon.png')); ?>'>
                                                                                    :&nbsp;</span>
                                                                            </td>
                                                                            <td class="text-right">
                                                                        ...
                                                                        <div class="card-body">
                                                                            <?php if(!Session::has('coupon')): ?>
                                                                                <h5 class="card-title all-caps">Have a
                                                                                    Coupon Code?</h5>
                                                                                <form
                                                                                    action="<?php echo e(route('home.coupon.apply')); ?>"
                                                                                    method="POST">
                                                                                    <?php echo e(csrf_field()); ?>
