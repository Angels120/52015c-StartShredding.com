            ...
            <div class="row" id="main">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div id="response"></div>
                        <form method="POST" action="<?php echo action('ProductController@store'); ?>" class="form-horizontal form-label-left" enctype="multipart/form-data">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="checkbox">
                                        <label><input type="checkbox" name="isTiers" id="tiers" value="1"><strong>Allow Services Tiers</strong></label>
                                    </div>
                                </div>
                            </div>
                            <div class="item form-group" id="pTiers" style="display: none;">
                                ...
                                <div class="col-md-2 col-sm-2 col-xs-2">
                                    ...
                                    <input class="form-control col-md-2 col-xs-2" name="standard" placeholder="e.g 20" /><br>

                                    <label for="name">Flex</label>
                                    <input class="form-control col-md-2 col-xs-2" name="flex" placeholder="e.g 20" /><br>

                                    <label for="name">Expedited</label>
                                    <input class="form-control col-md-2 col-xs-2" name="expedited" placeholder="e.g 20" />
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input class="form-control col-md-7 col-xs-12" name="plant_cost" placeholder="e.g 20" pattern="[0-9]+(\.[0-9]{0,2})?%?"
                                           title="Price must be a numeric or up to 2 decimal places." required="required" type="text">
                                </div>
                            </div>
