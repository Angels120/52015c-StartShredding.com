		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="<?php echo e(route('upload.document',['id' => $order->id])); ?>" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<input class="form-control" type="text" name="doc_id" id="" value="<?php echo e($docID); ?>" readonly>
						</div>
						<div class="form-group">
							<label class="label-control" for="order_number">Order Number</label>
							<input class="form-control" type="text" name="order_number" id="" value="<?php echo e($order->order_number); ?>">
						</div>
						<div class="form-group">
							<label class="label-control" for="booking_date">Order Date</label>
							<input class="form-control" type="text" name="booking_date" id="" value="<?php echo e($order->booking_date); ?>">
						</div>
						<div class="form-group">
