            ...
            <div class="row" id="main">
                ...
                <div class="go-title">
                    <div class="pull-right">
                        <a href="<?php echo url('admin/products'); ?>" class="btn btn-default btn-back"><i class="fa fa-arrow-left"></i> Back</a>
                    </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div id="response"></div>
                        <form method="POST" action="<?php echo action('ProductController@update',['id' => $product->id]); ?>" class="form-horizontal form-label-left" enctype="multipart/form-data">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" class="form-control col-md-7 col-xs-12" name="title" value="<?php echo e($product->title); ?>" placeholder="e.g Atractive Stylish Jeans For Women" required="required" type="text">
                                </div>
                            </div>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select class="form-control" name="mainid" id="maincats" required>
                                        ...
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($product->category[0] == $category->id): ?>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select class="form-control" name="subid" id="subs">
                                        ...
                                        <?php $__currentLoopData = $subs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($product->category[1] == $sub->id): ?>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select class="form-control" name="childid" id="childs">
                                        ...
                                        <?php $__currentLoopData = $child; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($product->category[2] == $data->id): ?>
                                                <option value="<?php echo e($data->id); ?>" selected><?php echo e($data->name); ?></option>
                                            <?php else: ?>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-12">
                                   <img style="max-width: 250px;" src="<?php echo e(url('assets/images/products')); ?>/<?php echo e($product->feature_image); ?>" id="adminimg" alt="No Featured Image Added">
                                </div>
                                <div class="col-md-3 col-sm-6 col-xs-12">
                            ...
                            <div class="item form-group" id="pSizes">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input class="form-control col-md-7 col-xs-12" name="sizes" value="<?php echo e($product->sizes); ?>" data-role="tagsinput"/>
                                </div>
                            </div>
                            <?php else: ?>
                                <div class="item form-group">
                            ...
                            <div class="item form-group" id="pTiers" style="display: none;">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Services Tiers<span class="required">*</span>
                                    <p class="small-label">(In <?php echo e($settings[0]->currency_code); ?>)</p>
                                </label>
                                <?php
                                ...
                                <div class="col-md-2 col-sm-2 col-xs-2">
                                    ...
                                    <input class="form-control col-md-2 col-xs-2" name="standard" placeholder="e.g 20"  value="<?php echo e($priceList['standard']); ?>"/><br>

                                    <label for="name">Flex</label>
                                    <input class="form-control col-md-2 col-xs-2" name="flex" placeholder="e.g 20" value="<?php echo e($priceList['flex']); ?>"/><br>

                                    <label for="name">Expedited</label>
                                    <input class="form-control col-md-2 col-xs-2" name="expedited" placeholder="e.g 20" value="<?php echo e($priceList['expedited']); ?>"/>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input class="form-control col-md-7 col-xs-12" name="price" value="<?php echo e($product->price); ?>" placeholder="e.g 20" pattern="[0-9]+(\.[0-9]{0,2})?%?"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input class="form-control col-md-7 col-xs-12" name="plant_cost" value="<?php echo e($product->plant_cost); ?>" placeholder="e.g 20" pattern="[0-9]+(\.[0-9]{0,2})?%?"
                                           title="Price must be a numeric or up to 2 decimal places." required="required" type="text">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Product Previous Price<span class="required">*</span>
                                    <p class="small-label">(In <?php echo e($settings[0]->currency_code); ?>, Leave Blank if not Required)</p>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input class="form-control col-md-7 col-xs-12" name="previous_price" value="<?php echo e($product->previous_price); ?>" placeholder="e.g 25" pattern="[0-9]+(\.[0-9]{0,2})?%?"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input class="form-control col-md-7 col-xs-12" name="stock" value="<?php echo e($product->stock); ?>" placeholder="e.g 15" pattern="[0-9]{1,10}" type="text">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <textarea name="policy" id="policy" class="form-control" rows="6"><?php echo e($product->policy); ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input class="form-control col-md-7 col-xs-12" name="tags" value="<?php echo e($product->tags); ?>" data-role="tagsinput"/>
                                </div>
                            </div>
                            <div class="item form-group">
