...
<head>
  ...
  <link class="main-stylesheet" href="<?php echo e(URL::asset('home_assets/css/productSelect.css')); ?>" rel="stylesheet" type="text/css" />
  <link class="main-stylesheet" href="<?php echo e(URL::asset('home_assets/new/style.css')); ?>" rel="stylesheet" type="text/css" />
  <link class="main-stylesheet" href="<?php echo e(URL::asset('home_assets/new/wizard.css')); ?>" rel="stylesheet" type="text/css" />
  <script src="<?php echo e(URL::asset('home_assets/map/js/jquery1.11.3.min.js')); ?>"></script>
  <script src="<?php echo e(URL::asset('home_assets/map/js/jquery.blockUI.js')); ?>"></script>
  <script src="<?php echo e(URL::asset('home_assets/js/main.vender.js')); ?>"></script>
  <script src="<?php echo e(URL::asset('home_assets/new/jquery.steps.js')); ?>"></script>
  <script src="<?php echo e(URL::asset('home_assets/new/main.js')); ?>"></script>
  <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
  <script type="text/javascript" src="<?php echo e(url('home_assets/js/functions.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('home_assets/js/customers.js')); ?>"></script>
  ...
  <script src="https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyCRu_qlT0HNjPcs45NXXiOSMd3btAUduSc&libraries=places">
    ...
    <link href="<?php echo e(URL::asset('home_assets/css/customers.css')); ?>" rel="stylesheet" type="text/css" media="screen" />
