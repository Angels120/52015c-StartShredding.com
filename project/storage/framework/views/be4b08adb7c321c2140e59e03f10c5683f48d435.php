            ...
            <div class="col-md-8">
                ...
                <div class="card card-borderless">
                    <ul class="nav nav-tabs nav-tabs-simple d-none d-md-flex d-lg-flex d-xl-flex" role="tablist"
                        ...
                        <?php if(Session::get('tab')=="account_billing"): ?>
                        <li class="nav-item">
                            ...
                            <div class="tab-pane" id="tab2hellowWorld">
                                ...
                                <div class="row column-seperation">
                                    <div class="col-lg-12">
                                        ...
                                        <?php endif; ?>
                                        <form
                                            action="<?php echo e(action('UserDetailController@updateDetails',['id' => $user->id])); ?>"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group form-group-default required">
                                                        ...
                                                        <input class="form-control" type="text" name="first_name"
                                                            id="dash_fname" value="<?php echo e($user->first_name); ?>" placeholder=""
                                                            required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group form-group-default">
                                                        ...
                                                        <input class="form-control" type="text" name="last_name"
                                                            id="dash_lname" value="<?php echo e($user->last_name); ?>" placeholder="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group form-group-default required">
                                                        ...
                                                        <input class="form-control" type="email" name="mail"
                                                            value="<?php echo e($user->email); ?>" id="dash_email" required disabled>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group form-group-default required">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group form-group-default ">
                                                        ...
                                                        <input class="form-control" type="text" name="instagram"
                                                            id="instagram" value="<?php echo e($user->instagram); ?>" placeholder="">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group form-group-default">
                                                        ...
                                                        <input class="form-control" type="text" name="face_book"
                                                            id="face_book" value="<?php echo e($user->face_book); ?>" placeholder="">
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="tab-pane" id="tab2FollowUs">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr class="text-center">
                                                                        ...
                                                                        <td class="fs-12">
                                                                            ...
                                                                            <a href="<?php echo e(route('user.multiple-address-edit', ['id' => $multi_address->id])); ?>"
                                                                                id="edit_multiaddress"
                                                                                class="bg-free-btn">Edit
                                                                            </a>
                                                                            <?php if($multi_address->address_alias !==
                                                                            'Default'): ?>
                                                                            |
                                    ...
                                    <div class="row column-seperation">
                                        <div class="auto-overflow col-lg-12">
                                            <form
                                                action="<?php echo e(action('UserDetailController@addMultipleAddress',['id' => $user->id])); ?>"
                                    ...
                                    <div class="tab-pane" id="tab2Inspire">
                                        ...
                                        <div class="row column-seperation">
                                            <div class="col-lg-12">
                                                ...
                                                <?php endif; ?>
                                                <form
                                                    action="<?php echo e(action('UserDetailController@passChange',['id' => $user->id])); ?>"
                                    ...
                                    <div class="tab-pane" id="tab2BillingSettings">
                                        ...
                                        <div class="row column-seperation">
                                            <div class="col-lg-12">
                                                ...
                                                <?php endif; ?>
                                                <form
                                                        action="<?php echo e(action('UserDetailController@updateBilling',['id' => $user->id])); ?>"
										...
										<div class="row column-separation">
                                                                                    <div class="col-lg-12">
                                                                                        <table class="table table-bordered">
                                                                                            <tbody>
                                                                                            <?php $__empty_1 = true; $__currentLoopData = $user->credit_cards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                                                                <tr>
                                                                                                    <td><?php echo e($card->maskNum
                                                                                                    ()); ?></td>
                                                                                                    <td>
                                                                                                        <?php echo e($card->exp_month); ?>/<?php echo e($card->exp_year); ?></td>
                                                                                                    <td>
                                                                                                        <a href="#"
