        ...
        $('#doSearch').click(function(){
            ...
            if(search_name_length < 3 && search_phone_length < 3){
                ...
                $.ajax({
                    ...
                    data: {'keyword': $('#txt_search_by_name').val(), 'phone': $('#txt_search_by_phone').val()},
                    success: function (data) {
                        $('.resultsMessage').hide();
                        $(".resultsTable").show();
                        $(".resultsTable").html(data);
    ...
    function openEditPopup(client_id) {
        $.ajax({
            ...
            success: function (data) {
                ...
                $(function() {
                    $('[name=cmb_province] option').filter(function() {
                        return ($(this).val() == client['Province']);
                    }).prop('selected', true);
                });
                $('#txt_fsa1').val(client['FSA1']);
                $('#txt_fsa2').val(client['FSA2']);
                $.blockUI({ message: $('#updateCustomerForm') });
            }
        });
    }
                    ...
                    <div class="inner">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row">
                        <form method="post" action="<?php echo e(route('vendor.customer_add')); ?>" id="main-form" class="basic-form horizontal-form col-md-12 col-sm-12 col-xs-12 customer_left_portion">
                                    ...
                                    <div class="address-form-block col-md-12 col-sm-12 col-xs-12 hide">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="col-sm-2">
                                                    <input type="text" name="phone[]" id="phone1" maxlength="3" placeholder="000">
                                                </div>
                                                <div class="col-sm-2">
                                                    <input type="text" name="phone[]" id="phone2" maxlength="3" placeholder="000">
                                                </div>
                                                <div class="col-sm-3">
                                                    <input type="text" name="phone[]" id="phone3" maxlength="4" placeholder="0000">
                                                </div>
                                            </div>
                                            <div class="col-xs-12">
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="col-sm-9">
                                                    <select name="province" class="form-control" placeholder="Province" id="province">
                                                        ...
                                                        <option value="6">Northwest Territorie</option>
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="row">
                                                        <div class="col-sm-3">
                                                            <input type="text" name="zip" maxlength="3" id="zip"  placeholder="">
                                                        </div>
                                                        <div class="col-sm-3">
                                            ...
                                            <div class="text-right col-xs-12">
                                                <div class="actions col-xs-12">
                                                    <button type="submit" data-next="step2" id="btnCreateClient" class="btn btn-success btn-next">Next<i class="icon-arrow-right"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<div class="blockUI blockMsg blockPage" style="z-index: 1011; display:none;position: absolute !important;" id="updateCustomerForm">
    <div class="background-container">
        ...
        <form action="" role="form" class="form-horizontal" id="ClientHomeForm" method="post" accept-charset="utf-8">
            <?php echo e(csrf_field()); ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <input name="txt_phone[]" class="form-control" maxlength="3" placeholder="000" id="txt_phone1" type="phone">
                </div>
                <div class="col-sm-2">
                    <input name="txt_phone[]" class="form-control" maxlength="3" placeholder="000" id="txt_phone2" type="phone">
                </div>
                <div class="col-sm-3">
                    <input name="txt_phone[]" class="form-control" maxlength="4" placeholder="0000" id="txt_phone3" type="phone">
                </div>
            </div>
            <div class="form-group">
