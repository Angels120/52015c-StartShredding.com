...
<style>
    @font-face {
        ...
        src: url('<?php echo e(url('assets/fonts/FrestyScript.eot')); ?>');
        src: url('<?php echo e(url('assets/fonts/FrestyScript.eot?#iefix')); ?>') format('embedded-opentype'),
        url('<?php echo e(url('assets/fonts/FrestyScript.woff2')); ?>') format('woff2'),
        url('<?php echo e(url('assets/fonts/FrestyScript.woff')); ?>') format('woff'),
        url('<?php echo e(url('assets/fonts/FrestyScript.ttf')); ?>') format('truetype'),
        url('<?php echo e(url('assets/fonts/FrestyScript.svg#FrestyScript')); ?>.svg#FrestyScript') format('svg');
        font-weight: normal;
        font-style: normal;
    }
    ...
    .card-btn button {
        border: 1px solid #010c23;
        padding: 10px 0px;
        background-image: url('<?php echo e(url('assets/img/btn-pattern.png')); ?>');
    ...
    .reccomend button {
        background-image: url('<?php echo e(url('assets/img/btn-pattern2.png')); ?>');
        background-size: auto;
        background-repeat: repeat-x;
    }
    ...
    .fashionista .card {
        color: #ffffff;
        background-image: url('<?php echo e(url('assets/img/card-bg.png')); ?>');
    }
        ...
        <div class="row">
            <div class="col-sm-8 col-sm-offset-2">
                ...
                <div class="row">
                    ...
                    <form id="trial_form" action="<?php echo e(route('buy.credits')); ?>">
                        <?php echo e(csrf_field()); ?>
                ...
                <div class="row">
                    <div class="col-sm-6 col-sm-offset-3">
                        <img src="<?php echo e(url('assets/img/paypal-logo.png')); ?>" alt="paypal"
