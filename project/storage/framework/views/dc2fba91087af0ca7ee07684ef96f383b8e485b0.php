...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#addItem").click(function () {
            $('.item>td.action').html($('<div class="form-group"><button class="btn btn-default removeItem" type="button"><i class="fa fa-minus"></i></button><span class="form-control-static">Remove</span></div>'));
    ...
    function rowTemplate() {
        ...
        template += '<td><div class="form-group"><div class="col-sm-10">';
        ...
        template += '<td class="action"><div class="form-group"><button class="btn btn-default removeItem" type="button"><i class="fa fa-minus"></i></button><span class="form-control-static">Remove</span></div></td>';
                    ...
                    <div class="inner">
                        <div id="wizard-form" class="wizard">
                            <ul class="steps">
                                ...
                                <li data-target="step2"  class="active"><span class="badge">2</span>Order<span class="chevron"></span></li>
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row">
									<form method="post" action="<?php echo e(route('vendor.order_add')); ?>" id="main-form" class="basic-form horizontal-form col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="step-content">
                            ...
                            <div class="step-pane">
                                <div class="col-sm-12 col-xs-12 col-md-12 service-block">
                                    <input type="hidden" name="hf_client_id" value="<?php echo e($_GET['client_id']); ?>">
                                    ...
                                    <table class="items">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        ...
                                                        <?php
                                                            ...
                                                            ?>
                                                            <select name="cmb_order_item[]" id="cmb_order_item" class="itemSelect form-control" style="width: 150px;" required="required">
                                        ...
                                        <tfoot>
                                            <tr>
                                                <td colspan="5" class="action"><button class="btn btn-default" id="addItem" type="button"><i class="fa fa-plus"></i></button> Add More </td>
                                            </tr>
                                            <tr>
                                                <td colspan="5">&nbsp;</td>
                                            </tr>
                                    ...
                                    <div class="text-right col-xs-12">
                                        ...
                                        <!--    <button type="button" data-prev="step1" class="btn btn-primary btn-prev">Back<i class="icon-arrow-left"></i></button>--->
