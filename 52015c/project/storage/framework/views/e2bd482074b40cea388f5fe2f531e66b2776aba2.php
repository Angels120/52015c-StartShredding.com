...
<?php $__env->startSection('content'); ?>
    ...
    <script type="text/javascript" src="<?php echo e(url('home_assets/js/functions.js')); ?>"></script>
    ...
    <section class="demo-hero-5" data-pages="parallax"
             data-pages-bg-image="<?php echo e(URL::asset('assets_new/assets/images/sub-banner.jpg')); ?>">
    ...
    <div class="container-fluid bg-master-lightest">
        <div class=" container container-fixed-lg">
            <div id="rootwizard" class="m-t-50 m-b-50">
                ...
                <form method="post" action="<?php echo e(url('/request_quote/submit')); ?>" id="main-form"
                                    ...
                                    <div class="sm-padding-5 sm-m-t-15 m-t-15">
                                        <div class="form-group form-group-default required">
                                            ...
                                            <input autocomplete="off" id="autocomplete" placeholder="Enter address here"
                                                   type="text" value="<?php echo e($address); ?>" class="form-control"
                                                   aria-required="true" style="width: 100%">
                                            <ul id="result" class="serachwrap" style="display: block;">
                                                <li title="<?php echo e($address); ?>" id="onload_click"><i
                                                            class="fa fa-map-marker"></i><?php echo e($address); ?></li>
                                            </ul>
                                            <script type="text/javascript">
                                                $(document).ready(function () {
                                    ...
                                    <div class="padding-30 sm-padding-5">
                                            ...
                                            <div class="row m-b-35">
                                                <div class="col-sm-4 overlay-div">
                                                    <a class="showSingle" target="1"
                                                       ...
                                                       onclick="service(this.id)">
                                                        <img src="<?php echo e(URL::asset('assets_new/assets/images/onetime.jpg')); ?>"
                                                             class="w-100 image">
                                                ...
                                                <div class="col-sm-4 overlay-div">
                                                    <a class="showSingle" target="2"
                                                       ...
                                                       onclick="service(this.id)">
                                                        <img src="<?php echo e(URL::asset('assets_new/assets/images/dropoff.jpg')); ?>"
                                                             class="w-100 image">
                                                ...
                                                <div class="col-sm-4 overlay-div">
                                                    ...
                                                    <a class="showSingle" target="3"
                                                       ...
                                                       onclick="service(this.id)">
                                                        <img src="<?php echo e(URL::asset('assets_new/assets/images/sheduled.jpg')); ?>"
                                                             class="w-100 image">
                                            ...
                                            <div id="type1" class="targetType">
                                                ...
                                                <div class="row second-selection">
                                                    <div class="col-sm-4" id="boxes-div">
                                                        <img src="<?php echo e(URL::asset('assets_new/assets/images/file-box.jpg')); ?>"
                                                             class="w-100 image">
                                                    ...
                                                    <div class="col-sm-4 type-box" id="garbage-div">
                                                        <img src="<?php echo e(URL::asset('assets_new/assets/images/garbage-bag.jpg')); ?>"
                                                             class="w-100 image">
                                                        <div class="box-title">
                                                            <h3>Garbage Bags</h3>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-4 type-box" id="pallets-div">
                                                        <img src="<?php echo e(URL::asset('assets_new/assets/images/plates.jpg')); ?>"
                                                             class="w-100 image">
                                                        <div class="box-title">
                                                            <h3>Pallets</h3>
                                                        </div>
                                        ...
                                        <div class="post-time">
                                            ...
                                            <label class="col-md-4 col-sm-4 col-xs-4">
                                                ...
                                                <span class="visible-xs hidden-md hidden-lg text-center margin-top-5">
                                                    <img style="width:32px;"
                                                         src="<?php echo e(URL::asset('home_assets/images/flexibleTime.png')); ?>"
                                            ...
                                            <label class="col-md-5 col-sm-4 col-xs-4" id="specific_date">
                                                ...
                                                <span class="visible-xs hidden-md hidden-lg text-center margin-top-5">
                                                    <img style="width:32px;"
                                                         src="<?php echo e(URL::asset('home_assets/images/specificDate.png')); ?>"
                                ...
                                <div class="col-md-7">
                                    <div class="padding-30 sm-padding-5">
                                        ...
                                        <div class="capbox">
                                            ...
                                            <div id="CaptchaDiv" onclick="changeText()"><?php echo e($var); ?></div>
