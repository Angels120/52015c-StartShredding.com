                            ...
                            <div id="footer_bottom">
                                <div id="sns_footer_bottom" class="footer" style='background-color:black;z-index:999;'>
                                    <div class="icon-container">
                                        ...
                                        <a class="shcart" href="<?php echo e(url('/cart')); ?>"><i class="fa fa-shopping-cart"></i></a>
                                        <?php else: ?>
                                        <a class="shcart" href="<?php echo e(url('/cart')); ?>"><i class="fa fa-shopping-cart"></i></a>
                                        <?php endif; ?>
                                        ...
                                        <div class="accountloy">
                                            <div class="inner">
                                                <a href="<?php echo e(route("user.product-favourite")); ?>"><i class="fas fa-heart"></i><br><span class="break"></span>Faves</a>
                                            </div>
                                            <div class="inner">
                                                <a href="<?php echo e(route('user.myorders')); ?>"><i class="fas fa-file-invoice"></i><br><span class="break"></span>Orders</a>

                                            </div>
                                            <div class="inner hid">
                                                <a href="<?php echo e(url('/locations')); ?>"><i class="fas fa-map-marked-alt"></i><br><span class="break"></span>Drop Off</a>
                                            </div>
                                        </div>
                                        <div class="transhop">
                                            <!-- <div class="inner hid">
                                            ...
                                            <div class="inner">
                                                <a href="<?php echo e(route("user-dashboard.index")); ?>"><i class="fas fa-user-cog"></i><br><span class="break"></span>Account</a>
                                            </div>
                                            <!-- <div class="inner">
