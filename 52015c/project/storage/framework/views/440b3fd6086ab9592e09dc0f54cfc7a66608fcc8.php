...
// $quantity = null;
 ?>
<?php $__currentLoopData = $responsedet; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $res): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<?php 
                                        ...
                                        <div class="ube-card-body">
                                            <div class="bill-wrapper">
                                                ...
                                                <div class="bill-address">
                                                    <div class="customer-name"><?php echo e($user->name); ?></div>
                                                    <div class="customer-lane"><?php echo e($multiple_address->street); ?>

                                                    </div>
                                                    <div class="customer-lane"><?php echo e($multiple_address->city); ?></div>
                                                    <div class="customer-lane"><?php echo e($multiple_address->province); ?></div>
                                                    <div class="customer-zip"><?php echo e($multiple_address->zip); ?></div>
                                                    <div class="customer-email"><?php echo e($user->email); ?></div>
                                                </div>
                                            </div>
                                            <div class="delivery-wrapper">
                                                ...
                                                <div class="delivery-address">
                                                    ...
                                                    <div class="customer-lane"><?php echo e($multiple_address->province); ?></div>
                                                    <div class="customer-zip"><?php echo e($multiple_address->zip); ?></div>
                                                    <div class="customer-phone"><?php echo e($user->phone); ?></div>
                                            ...
                                            <div class="btn-area">
                                                ...
                                                <a href="<?php echo e(route('user.account-details')); ?>" class="btn btn-primary"
                                                    target="_blank">View
                                                    Profile page</a>
                                    ...
                                    <div class="ube-card quickplay">
                                        ...
                                        <div class="ube-card-body">
                                            <div class="order-summery">
                                                ...
                                                <div class="row os-item">
                                                    ...
                                                    <div class="col-xs-4 os-price" id="new-balance-row">
                                                        <b>
                                                            $<?php echo e(number_format((float)$user->balance - $grandTotal, 2, '.', '')); ?></b>
                                                    </div>
                                                </div>

                                                <form action="<?php echo e(route('purchase.order')); ?>" method="POST" id="pay_now_form">
                                                    <?php echo e(csrf_field()); ?>


                                                    <input type="hidden" name="products" id="products" value="<?php echo e($products); ?>" />
                                                    <input type="hidden" name="quantities" id="quantities" value="<?php echo e($quantities); ?>" />
                                                    <input type="hidden" name="customer" id="customer" value="<?php echo e(Auth::guard('profile')->user()->id); ?>" />

                                                    <input type="hidden" name="discount" id="discount" value="<?php echo e(Session::has('coupon') ? Session::get('coupon')->value : null); ?>" />
                                                    <input type="hidden" name="discount_type" id="discount_type" value="<?php echo e(Session::has('coupon') ? Session::get('coupon')->type : null); ?>" />
                                                    <input type="hidden" name="subtotal" id="subtotal" value="<?php echo e(number_format((float)$price, 2, '.', '')); ?>" />
                                                    <input type="hidden" name="discount_amount" id="discount_amount" value="<?php echo e(number_format((float)$discount, 2, '.', '')); ?>" />
                                                    <input type="hidden" name="delivery" id="delivery" value="<?php echo e(number_format((float)$delivery_fee, 2, '.', '')); ?>" />
                                                    <input type="hidden" name="tax" id="tax" value="<?php echo e(number_format((float) ($price+$delivery_fee) * 13/100, 2, '.', '')); ?>" />
                                                    <input type="hidden" name="make_it_count" id="make_it_count" value="<?php echo e(number_format((float)$donation_amount, 2, '.', '')); ?>" />
                                                    <input type="hidden" name="total" id="total" value="<?php echo e(number_format((float)($price+$delivery_fee) * 13/100 + $price - $discount + $delivery_fee + $donation_amount, 2, '.', '')); ?>" />

                                                    <div class="row">
                                                        <div class="own-space"></div>
                                                        <div class="col-xs-12 text-center">
                                                            <?php if(($user->balance == 0) || ($user->balance < $grandTotal)): ?>
                                                                <button type="submit" class="paynow-btn" disabled><span
                                                                    class="sr-only">Checkout</span></button>
                                                                <?php elseif($user->balance < 25.00): ?> <button type="submit"
                                            ...
                                            <div class="btn-area">
                                                ...
                                                <a href="<?php echo e(url('/buy-credits')); ?>" class="btn btn-primary">Get
                                                    Credits</a>

                                            </div>
                                            <?php if(($user->balance == 0) || ($user->balance < $grandTotal)): ?> <p
                                                ...
                                                the
                                                purchase!</p>
                                            <?php elseif($user->balance < 25.00): ?> <p class="text-center warning-text">
...
and the Janeen Foundation" data-original-title="Make It Count">Make it Count <i
                                                ...
                                                <form action="<?php echo e(route('purchase.order')); ?>" method="post" id="confirm_and_buy_form">
                                                    <?php echo e(csrf_field()); ?>
                                                    ...
                                                    <div class="btn-area text-right">
                                                        <?php if(($user->balance == 0) || ($user->balance < $grandTotal)): ?>
                                                            ...
                                                            disabled>
                                                            Confirm</button>
                                                            <?php elseif($user->balance < 25.00): ?> <button id="confirmBtn"
                                                                ...
                                                                <?php endif; ?>
                                                                <?php if(($user->balance == 0) || ($user->balance <
                                                                    ...
                                                                    the
                                                                    purchase!</p>
                                                                <?php elseif($user->balance < 25.00): ?> <p
                                                                    class="text-center warning-text">
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <section>
                            <div>
                                <form action="<?php echo e(route('buy.credits')); ?>">
                                    <?php echo e(csrf_field()); ?>
...
<script>
    $(document).ready(function (e) {
        ...
        // $.ajax({
        //         url: "<?php echo route('purchase.order'); ?>",
        //         data: $formData,
        //         type: 'POST',
        //         success: function(result){
        //             // console.log(result);
        //             if(result == "success"){
        //                 location.href = "<?php echo route('order.confirmed'); ?>";
        //             }
        //             else{
