            ...
            <div class="row" id="main">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <form action="<?php echo e(url('/admin/orders')); ?>">
                            <div class="row">
                                <div class="col-md-1">
                                    <div class="form-group">
                                        <label for="blog_id" class="control-label">ID #</label>
                                        <input type="text" class="form-control" name="id" value="<?php echo e(request()->get('id')); ?>">
                                    </div>
                                </div>
                                <div class="col-md-1">
                                    <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="email" value="<?php echo e(request()->get('email')); ?>">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="blog_id" class="control-label">Customer Name</label>
                                        <input type="text" class="form-control" name="customer_name" value="<?php echo e(request()->get('customer_name')); ?>">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                        ...
                        <table class="table table-striped table-bordered" cellspacing="0" id="example" width="100%">
                            ...
                            <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php else: ?>
                                    <tr class="">
                                        <?php endif; ?>
                                        <td><input type="checkbox" name="chk_order[]" id="chk_job_<?php echo e($order->id); ?>"
                                                   value="<?php echo e($order->id); ?>" email_address="<?php echo e($order->customer_email); ?>"
                                        ...
                                        <td><?php echo e((array_sum($order->quantities)!=0)?array_sum($order->quantities):'-'); ?></td>
                                        <td><?php echo e(($order->pay_amount!='')?"$ ".$order->pay_amount:'-'); ?></td>
                                        <td><?php echo e(($order->method!='')?$order->method:'-'); ?></td>
                                        <td><a href="#" class="btn btn-primary btn-xs"
                                               readonly><?php echo e(ucfirst($order->status)); ?></a></td>
                                        <td>

                                            <a href="<?php echo e(url('admin/orders/show/'.$order->id)); ?>" class="btn btn-primary btn-xs"><i
                                                        class="fa fa-check"></i> View Details </a>

                                            <a href="orders/email/<?php echo e($order->id); ?>" class="btn btn-primary btn-xs"><i
                                                        class="fa fa-send"></i> Send Email</a>
                                        <!--
                                    ​<span class="dropdown">
                                        <button class="btn btn-primary dropdown-toggle btn-xs" type="button"
                                            data-toggle="dropdown"><?php echo e(ucfirst($order->status)); ?>

                                                <span class="caret"></span></button>
                                            <ul class="dropdown-menu">
                                                <li><a href="orders/status/<?php echo e($order->id); ?>/scheduled">Scheduled</a></li>
                                            <li><a href="orders/status/<?php echo e($order->id); ?>/in transit">In Transit</a></li>
                                            <li><a href="orders/status/<?php echo e($order->id); ?>/at plant">At Plant</a></li>
                                            <li><a href="orders/status/<?php echo e($order->id); ?>/on delivery">On Delivery</a></li>
                                            <li><a href="orders/status/<?php echo e($order->id); ?>/at plant completed">At Plant
                                                    Completed</a></li>
                                            <li><a href="orders/status/<?php echo e($order->id); ?>/completed">Completed</a></li>
                                            <li><a href="orders/status/<?php echo e($order->id); ?>/completed at store">Completed At
                                                    Store</a></li>
                                        </ul>
                                    </span> -->
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="mail_form" method="post"
                                              action="<?php echo e(url('admin/orders/bulkMailSend')); ?>">
                                            <div class="col-md-12">
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select class="form-control email_twmplate" name="template"
                                                            ...
                                                            <?php $__currentLoopData = $order_status_mails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($status['status']); ?>"
                                                                        content="<?php echo e($status['email_body']); ?>"
                                                                        subject="<?php echo e($status['email_subject']); ?>"><?php echo e($status['status']); ?>
...
<?php $__env->startSection('footer'); ?>
    ...
    <script src="<?php echo asset('new_assets/assets/plugins/ckeditor/ckeditor.js'); ?>"></script>
    <script src="<?php echo asset('new_assets/assets/plugins/ckeditor/jquery-ckeditor.js'); ?>"></script>
<?php $__env->stopSection(); ?>
