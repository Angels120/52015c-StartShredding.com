            ...
            function callback(predictions, status) {
                ...
                if (predictions != '') {
                    for (var i = 0; i < predictions.length; i++) {
                        resultData += '<li title="' + predictions[i].description + '"><a href="<?php echo e(url("/request_quote")); ?>?address=' + predictions[i]
                        ...
                        <div class="slider-wrapper">
                            <div class="background-wrapper" data-swiper-parallax="30%">
                                ...
                                <div class="background"
                                     data-pages-bg-image="<?php echo e(URL::asset('assets_new/assets/images/new-slider-1.jpg')); ?>"></div>
                            </div>
                        </div>
                        <!-- END IMAGE PARRALAX -->
                        <!-- BEGIN CONTENT -->
                                            ...
                                            <div class="col-md-12 no-padding col-xs-12">
                                               ...
                                               <div class="banner-logo m-t-35 m-b-15" data-aos="fade-down"
                                                    ...
                                                    <img class="xs-image-responsive-height image-responsive-width"
                                                         src="<?php echo e(URL::asset('assets_new/assets/images/banner-logos.png')); ?>"
                                                         alt="Banner Logos">
                                                </div>
                                                </div>
                    ...
                    <div class="swiper-slide fit">
                        ...
                        <div class="slider-wrapper">
                            <div class="background-wrapper" data-swiper-parallax="30%">
                                <!-- YOUR BACKGROUND IMAGE HERE, YOU CAN ALSO USE IMG with the same classes -->
                                <div class="background"
                                     data-pages-bg-image="<?php echo e(URL::asset('assets_new/assets/images/new-slider-2.jpg')); ?>"></div>
                            </div>
                        </div>
                        <!-- END IMAGE PARRALAX -->
                        <!-- BEGIN CONTENT -->
        ...
        <div class="row">
            <div class="col-md-4 text-center bg-success hover-push demo-story-block">
                <div class="hover-backdrop"
                     style="background:url(<?php echo e(URL::asset('assets_new/assets/images/feature_1.jpg')); ?>)"></div>
            ...
            <div class="col-md-4 text-center bg-success hover-push demo-story-block">
                <div class="hover-backdrop"
                     style="background:url(<?php echo e(URL::asset('assets_new/assets/images/feature_2.jpg')); ?>)"></div>
                <div class="hover-caption bottom-left bottom-right p-b-40">
            ...
            <div class="col-md-4 text-center bg-success hover-push demo-story-block">
                <div class="hover-backdrop"
                     style="background:url(<?php echo e(URL::asset('assets_new/assets/images/feature_3.jpg')); ?>)"></div>
                <div class="hover-caption bottom-left bottom-right p-b-40">
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="m-t-15" data-aos="fade-right" data-aos-duration="1500">
                            <img alt="" class="image-responsive-height image-responsive-width"
                                 src="<?php echo e(URL::asset('assets_new/assets/images/off-site-shreding.jpg')); ?>"
                                 id="mobile_phone">
                        </div>
                    </div>
            ...
            <div class="row m-t-30">
                ...
                <div class="col-md-6 col-sm-6 text-right sm-text-center sm-p-l-0 xs-p-r-0" data-aos="fade-left"
                    ...
                    <img class="xs-image-responsive-height sm-no-padding image-responsive-width image-responsive-height xs-m-t-35"
                         src="<?php echo e(URL::asset('assets_new/assets/images/mobile-shreding.jpg')); ?>" alt="">
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-4 col-sm-offset-3" data-aos="fade-up"
                        ...
                        <img class="p-r-40 m-t-10 xs-image-responsive-height sm-no-padding"
                             src="<?php echo e(URL::asset('assets_new/assets/images/city-shredding.jpg')); ?>" alt="">
                    </div>
                </div>
            </div>
        </div>
